...
class test_002_web_Merchant(TestBaseCase):
    def test_001_api_78dk_platform_mm_base_saveMerchant(self):
        ...
        res = json.loads(PlatformAction.test_api_78dk_platform_mm_base_saveMerchant(note='备注', name=merchantname,
            parentmerchantuuid='', shortname=merchantname[:5] + '商户简称', channeluuid=channelid, industryfirst=1,
            city="110100", industrysecond=6, province="110000"))
    ...
    def test_003_api_78dk_platform_mm_base_viewMerchantList(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_mm_base_viewMerchantList(pagecurrent=1, pagesize=10,
              name=merchantname,openclosestate='open',auditstate='imperfect',contractstatus='overdue',
    ...
    def test_004_api_78dk_platform_mm_base_viewMerchantList_all(self):
        ...
        res = PlatformAction.test_api_78dk_platform_mm_base_viewMerchantList(pagecurrent=1, pagesize=10, name='',
              openclosestate='open',auditstate='imperfect',contractstatus='overdue',
              freezestate='normal',overquotastatus='yes')
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_005_api_78dk_platform_mm_base_updateMerchant(self):
        ...
        res = PlatformAction.test_api_78dk_platform_mm_base_updateMerchant(merchantuuid=merchant_uuid, note='',
            parentmerchantuuid='', name=merchantname, channeluuid=channelid, shortname=merchantname + '商户简称',
            industryfirst=0, city=0, industrysecond=0, province=0)
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_006_api_78dk_platform_mm_state_viewStateMerchantList_all(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_mm_state_viewStateMerchantList(name='', pagecurrent=1, pagesize=10)
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['data']['currentPage'], 1)
        Assertion.verity(json.loads(res)['data']['pageSize'], 10)
    ...
    def test_007_api_78dk_platform_mm_state_viewStateMerchantList(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_mm_state_viewStateMerchantList(pagecurrent=1, pagesize=10,
                                                                                   name=merchantname)
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_009_api_78dk_platform_mm_examine_viewExamineMerchantList_all(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_mm_examine_viewExamineMerchantList(pagesize=10, pagecurrent=1,
                                                                                       name='')
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['data']['currentPage'], 1)
    ...
    def test_012_api_78dk_platform_mm_money_saveMerchantMoney_amountday_none(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_mm_money_saveMerchantMoney(amountday='', amountmonth=3000000,
            amountsingle=30000, amountsum=5000000, merchantuuid=merchant_uuid, moneyconfiguuid='', zoomcoefficient=0.5,
            depositnotice='123')
    ...
    def test_013_api_78dk_platform_mm_money_saveMerchantMoney_amountday_error(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_mm_money_saveMerchantMoney(amountday=-1, amountmonth=3000000,
            amountsingle=30000, amountsum=5000000, merchantuuid=merchant_uuid, moneyconfiguuid='', zoomcoefficient=0.5,
            depositnotice='')
        Assertion.verity(json.loads(res)['code'], '20000')
    ...
    def test_014_api_78dk_platform_mm_money_saveMerchantMoney_amountmonth_none(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_mm_money_saveMerchantMoney(amountday=150000, amountmonth='',
            amountsingle=30000, amountsum=5000000, merchantuuid=merchant_uuid, moneyconfiguuid='', zoomcoefficient=0.5,
            depositnotice='')
        Assertion.verity(json.loads(res)['code'], '20000')
        Assertion.verity(json.loads(res)['msg'], '系统发生内部异常，请稍候再试')
    ...
    def test_015_api_78dk_platform_mm_money_saveMerchantMoney_amountmonth_error(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_mm_money_saveMerchantMoney(amountday=150000, amountmonth=-1,
            amountsingle=30000, amountsum=5000000, merchantuuid=merchant_uuid, moneyconfiguuid='', zoomcoefficient=0.5,
            depositnotice='')
        Assertion.verity(json.loads(res)['code'], '20000')
    ...
    def test_016_api_78dk_platform_mm_money_saveMerchantMoney_amountsingle_none(self):
        ...
        res = PlatformAction.test_api_78dk_platform_mm_money_saveMerchantMoney(amountday=150000, amountmonth=3000000,
            amountsingle='', amountsum=5000000, merchantuuid=merchant_uuid, moneyconfiguuid='', zoomcoefficient=0.5,
            depositnotice='')
        Assertion.verity(json.loads(res)['code'], '20000')
        Assertion.verity(json.loads(res)['msg'], '系统发生内部异常，请稍候再试')
    ...
    def test_017_api_78dk_platform_mm_money_saveMerchantMoney_amountsum_none(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_mm_money_saveMerchantMoney(amountday=150000, amountmonth=3000000,
            amountsingle=30000, amountsum='', merchantuuid=merchant_uuid, moneyconfiguuid='', zoomcoefficient=0.5,
            depositnotice='')
        Assertion.verity(json.loads(res)['code'], '20000')
        Assertion.verity(json.loads(res)['msg'], '系统发生内部异常，请稍候再试')
    ...
    def test_018_api_78dk_platform_mm_money_saveMerchantMoney_amountsum_error(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_mm_money_saveMerchantMoney(amountday=150000, amountmonth=3000000,
            amountsingle=30000, amountsum=-1, merchantuuid=merchant_uuid, moneyconfiguuid='', zoomcoefficient=0.5,
            depositnotice='')
        Assertion.verity(json.loads(res)['code'], '20000')
    ...
    def test_019_api_78dk_platform_mm_money_saveMerchantMoney_merchantuuid_none(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_mm_money_saveMerchantMoney(amountday=150000, amountmonth=3000000,
            amountsingle=30000, amountsum=5000000, merchantuuid='', moneyconfiguuid='', zoomcoefficient=0.5,
            depositnotice='')
        Assertion.verity(json.loads(res)['code'], '20000')
    ...
    def test_020_api_78dk_platform_mm_money_saveMerchantMoney_merchantuuid_error(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_mm_money_saveMerchantMoney(amountday=150000, amountmonth=3000000,
            amountsingle=30000, amountsum=5000000, merchantuuid=-1, moneyconfiguuid='', zoomcoefficient=0.5,
            depositnotice='123')
        Assertion.verity(json.loads(res)['code'], '20000')
        Assertion.verity(json.loads(res)['msg'], '商户uuid不正确!')

    @unittest.skip('非必填，去掉校验')
    def test_021_api_78dk_platform_mm_money_saveMerchantMoney_depositnotice_none(self):
        """
        新增额度管理
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_mm_money_saveMerchantMoney(amountday=150000, amountmonth=3000000,
            ...
            depositnotice='')
        Assertion.verity(json.loads(res)['code'], '20000')
        Assertion.verity(json.loads(res)['msg'], '保证金缴纳提示不能为空!')
    ...
    def test_024_api_78dk_platform_mm_money_updateMerchantMoney(self):
        ...
        res = PlatformAction.test_api_78dk_platform_mm_money_updateMerchantMoney(amountday=10000, amountmonth=300000,
            amountsingle=10000, amountsum=500000, merchantuuid=merchant_uuid, moneyconfiguuid=money_config_uuid,
    ...
    def test_027_api_78dk_platform_mm_money_viewMerchantMoneyList_not_exits(self):
        ...
        """
        not_exist_name = '<meta http-equiv="Content-Type"content="text/html;charset=UTF-8"/>'
        res = PlatformAction.test_api_78dk_platform_mm_money_viewMerchantMoneyList(pagecurrent=1, pagesize=10,
                                                                                   name=not_exist_name)
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['data']['currentPage'], 1)
    ...
    def test_029_api_78dk_platform_mm_money_merchantMoneyEnlarge(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_mm_money_merchantMoneyEnlarge(uid=money_config_uuid,
                                                                                  zoomcoefficient=2)
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_030_api_78dk_platform_mm_base_saveMerchant_not_name(self):
        ...
        """
        res = json.loads(
            PlatformAction.test_api_78dk_platform_mm_base_saveMerchant(note='备注', name='', parentmerchantuuid='',
                shortname=merchantname + '商户简称', channeluuid=channelid, industryfirst=0, city=0, industrysecond=0,
                province=0))
    ...
    def test_031_api_78dk_platform_mm_base_saveMerchant_not_shortname(self):
        ...
        """
        res = json.loads(PlatformAction.test_api_78dk_platform_mm_base_saveMerchant(note='备注', name=merchantname,
            parentmerchantuuid='', shortname='', channeluuid=channelid, industryfirst=0, city=0, industrysecond=0,
            province=0))
        Assertion.verity(res['code'], '20000')
    ...
    def test_032_api_78dk_platform_mm_base_saveMerchant_not_channeluuid(self):
        ...
        """
        res = json.loads(PlatformAction.test_api_78dk_platform_mm_base_saveMerchant(note='备注', name=merchantname,
            parentmerchantuuid='', shortname=merchantname + '商户简称', channeluuid='', industryfirst=0, city=0,
    ...
    def test_033_api_78dk_platform_mm_base_legal_saveLegalPerson_not_name(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_mm_base_legal_saveLegalPerson(cardnumber=cardnumber,
            channelormerchantuuid=merchant_uuid, legalpersonuuid='', mobile=mobile, name='', effectivetimebegin='',
            effectivetimeend='')
        Assertion.verity(json.loads(res)['code'], '20000')
    ...
    def test_034_api_78dk_platform_mm_base_legal_saveLegalPerson_not_mobile(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_mm_base_legal_saveLegalPerson(cardnumber=cardnumber,
            channelormerchantuuid=merchant_uuid, legalpersonuuid='', mobile='', name=name, effectivetimebegin='',
            effectivetimeend='')
        Assertion.verity(json.loads(res)['code'], '20000')
    ...
    def test_035_api_78dk_platform_mm_base_legal_saveLegalPerson_not_cardnumber(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_mm_base_legal_saveLegalPerson(cardnumber='',
            channelormerchantuuid=merchant_uuid, legalpersonuuid='', mobile=mobile, name=name, effectivetimebegin='',
            effectivetimeend='')
        Assertion.verity(json.loads(res)['code'], '20000')
    ...
    def test_036_api_78dk_platform_mm_base_legal_saveLegalPerson_error_mobile(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_mm_base_legal_saveLegalPerson(cardnumber=cardnumber,
            channelormerchantuuid=merchant_uuid, legalpersonuuid='', mobile='234567890123', name=name,
    ...
    def test_037_api_78dk_platform_mm_base_legal_saveLegalPerson(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_mm_base_legal_saveLegalPerson(cardnumber=cardnumber,
            channelormerchantuuid=merchant_uuid, legalpersonuuid='', mobile=mobile, name=name,
            effectivetimebegin="2019-08-01", effectivetimeend="2019-09-30")
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_038_api_78dk_platform_mm_base_legal_saveLegalPerson_error_cardnumber(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_mm_base_legal_saveLegalPerson(cardnumber='格式错误2',
            channelormerchantuuid=merchant_uuid, legalpersonuuid='', mobile=mobile, name=name, effectivetimebegin='',
            effectivetimeend='')
        Assertion.verity(json.loads(res)['code'], '20000')
        Assertion.verity(json.loads(res)['msg'], '身份证格式错误,')
    ...
    def test_041_api_78dk_platform_mm_base_legal_updateLegalPerson(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_mm_base_legal_updateLegalPerson(channelormerchantuuid=merchant_uuid,
            mobile=mobile, name=name, cardnumber=cardnumber, effectivetimebegin='', effectivetimeend='',
    ...
    def test_042_api_78dk_platform_mm_base_clear_saveClearingAccount(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_mm_base_clear_saveClearingAccount(accountname=name,
            ...
            city="110100", clearingaccountuuid='', linenumber='6756765756', province="110000", region="110101")
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_048_api_78dk_platform_mm_base_business_updateBusinessInfor(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_mm_base_business_updateBusinessInfor(businessaddress='天府软件园',
            businessaddressgpsloction='', businessaddresszipcode='000000', businesshoursendtime='18:30',
            businesshoursstarttime='08:30', businessinformationuuid=businessInformationUuid,
            businessregistrationnumber='', channelormerchantuuid=merchant_uuid, documentaddress='天府软件园', email=email,
            organizationcode="567657675765", socialunifiedcreditcode="34534543534", storerentalendtime='2019-01-12',
            storerentalstarttime='2018-01-12', taxregistrationnumber='34543543543', documentprovince="510000",
            documentcity="510100", documentregion="510104", documentregionname='', businessprovince="510000",
            businesscity="510100", businessregion="510104", businessprovincename='', businesscityname='',
            businessregionname='', documentprovincename='', documentcityname='', installmentcooperationorgs=[],
    ...
    def test_049_api_78dk_platform_mm_base_store_saveStore(self):
        ...
        res = PlatformAction.test_api_78dk_platform_mm_base_store_saveStore(businessaddress='经营地址',
            businessaddressgpsloction='', managername=name, managerphone=mobile, merchantuuid=merchant_uuid,
            storeuuid="", storename=store_name, province=510000, city=510100, region=510104, provincename='',
            cityname='', regionname='', idcardnumber=cardnumber, numberbegindate=begin, numberenddate=end,
            leasetimeend=end, area='100', email=email, employeesnum='10', leasetimebegin=begin)
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
        global store_uuid
    ...
    @unittest.skip('去掉')
    def test_050_api_78dk_platform_mm_base_store_uploadImageRoleList(self):
        image_url = "FjHpyILVVxjHksSyGsVKmQlnI01T"
        keys = ["MDFZRSFZZM", "MDFZRSFZFM", "MDFZRSFZSC", "MDWBHJZ", "MDNBHJZ", "MDQTLOGO", "MDZLHT", "MDPXXY"]
        images = [{"fileName": '1', "key": key, "uid": merchant_uuid, "url": image_url} for key in keys]
        res = json.loads(PlatformAction.test_api_78dk_platform_mm_base_store_uploadImageRoleList(images))
        Assertion.verity(res['code'], '10000')
        Assertion.verity(res['msg'], '成功')
    ...
    def test_051_api_78dk_platform_mm_base_store_saveImagesAndChange_add(self):
        ...
        images = [{"fileName": '1','handleType':'add', "sysImageKey": imagekey, 'oldImageUuid':'',"storeUuid": store_uuid, "key": key} for imagekey in sysImageKey]
        res = json.loads(PlatformAction.test_api_78dk_platform_mm_base_store_saveImagesAndChange(images))
        Assertion.verity(res['code'], '10000')
        Assertion.verity(res['msg'], '成功')
    ...
    def test_052_api_78dk_platform_mm_base_addStoreBusiness_storeExamine_viewImageRoleList(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_mm_base_store_viewImageRoleList(uid=store_uuid)
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
        global dict_list
        dict_list = dict()
    ...
    def test_052_api_78dk_platform_mm_base_store_saveImagesAndChange_edit(self):
        ...
        # sysImageKey = ["MDFZRSFZZM", "MDFZRSFZFM", "MDFZRSFZSC", "MDWBHJZ", "MDNBHJZ", "MDQTLOGO", "MDZLHT", "MDPXXY"]
        images = [{"fileName": '1','handleType':'edit', "sysImageKey": imagekey, 'oldImageUuid':oldstoreImageUuid,"storeUuid": store_uuid, "key": key} for imagekey, oldstoreImageUuid in dict_list.items()]
        res = json.loads(PlatformAction.test_api_78dk_platform_mm_base_store_saveImagesAndChange(images))
        Assertion.verity(res['code'], '10000')
        Assertion.verity(res['msg'], '成功')
    ...
    def test_053_api_78dk_platform_mm_base_store_saveImagesAndChange_normal(self):
        ...
        key = "FjHpyILVVxjHksSyGsVKmQlnI01T"
        # sysImageKey = ["MDFZRSFZZM", "MDFZRSFZFM", "MDFZRSFZSC", "MDWBHJZ", "MDNBHJZ", "MDQTLOGO", "MDZLHT", "MDPXXY"]
        images = [{"fileName": '1','handleType':'normal', "sysImageKey": imagekey, 'oldImageUuid':oldstoreImageUuid,"storeUuid": store_uuid, "key": key} for imagekey, oldstoreImageUuid in dict_list.items()]
        res = json.loads(PlatformAction.test_api_78dk_platform_mm_base_store_saveImagesAndChange(images))
        Assertion.verity(res['code'], '10000')
        Assertion.verity(res['msg'], '成功')
    ...
    def test_055_api_78dk_platform_mm_base_store_saveImagesAndChange_add(self):
        ...
        key = "FjHpyILVVxjHksSyGsVKmQlnI01T"
        # sysImageKey = ["MDFZRSFZZM", "MDFZRSFZFM", "MDFZRSFZSC", "MDWBHJZ", "MDNBHJZ", "MDQTLOGO", "MDZLHT", "MDPXXY"]
        images = [{"fileName": '1','handleType':'add', "sysImageKey": imagekey, 'oldImageUuid':'',"storeUuid": store_uuid, "key": key} for imagekey, oldstoreImageUuid in dict_list.items()]
        res = json.loads(PlatformAction.test_api_78dk_platform_mm_base_store_saveImagesAndChange(images))
        Assertion.verity(res['code'], '10000')
        Assertion.verity(res['msg'], '成功')
    ...
    def test_056_api_78dk_platform_mm_base_store_updateStore(self):
        ...
        # loginAction.global_dict.set(store_uuid=store_uuid)
        res = PlatformAction.test_api_78dk_platform_mm_base_store_updateStore(businessaddress='经营地址',
            businessaddressgpsloction='GPS地址', managername=name, managerphone='18911390729',
            merchantuuid=merchant_uuid, storeuuid=store_uuid, province=510000, city=510100, region=510104,
            provincename='阿萨德', cityname='带我去', regionname='看监控', storename=store_name,
            idcardnumber='511325199309280326', numberbegindate='2019-01-01', numberenddate='2019-12-01',
            employeesnum='111', area='12', email='song@78dk.com', leasetimebegin='2019-01-01',
    ...
    def test_057_api_78dk_platform_mm_base_store_viewStoreList(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_mm_base_store_viewStoreList(pagecurrent=1, name=store_name,
        pagesize=10, uid=store_uuid, auditstate='pass', freezestate='normal', managername='', sign='overdue')
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['data']['currentPage'], 1)
        Assertion.verity(json.loads(res)['data']['pageSize'], 10)
    ...
    def test_058_api_78dk_platform_mm_base_store_freeze(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_mm_base_store_viewStore(uid=store_uuid)
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_059_api_78dk_platform_mm_base_store_viewStore(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_mm_base_store_freeze(uid=store_uuid, type='freeze')
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
        # Assertion.verity(json.loads(res)['data']['storeUuid'], merchant_uuid)
    ...
    def test_060_api_78dk_platform_mm_base_store_viewStore_uuid_none(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_mm_base_store_freeze(uid='', type='freeze')
        Assertion.verity(json.loads(res)['code'], '20000')
    ...
    def test_061_api_78dk_platform_mm_base_store_viewStore_uuid_error(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_mm_base_store_freeze(uid=MockData.words_en(20), type='freeze')
        Assertion.verity(json.loads(res)['code'], '20000')
    ...
    def test_062_api_78dk_platform_mm_base_store_viewStore_type_error(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_mm_base_store_freeze(uid=store_uuid, type='hsjdh')
        Assertion.verity(json.loads(res)['code'], '20000')
    ...
    def test_063_api_78dk_platform_mm_base_store_viewStore_type_none(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_mm_base_store_freeze(uid=store_uuid, type='')
        Assertion.verity(json.loads(res)['code'], '20000')
        # Assertion.verity(json.loads(res)['data']['storeUuid'], merchant_uuid)
    ...
    def test_064_api_78dk_platform_mm_base_store_viewStore(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_mm_base_store_freeze(uid=store_uuid, type='normal')
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
        # Assertion.verity(json.loads(res)['data']['storeUuid'], merchant_uuid)
    ...
    def test_065_api_78dk_platform_mm_saveContractImages(self):
        ...
        images = [{"fileName": '1', "key": key, "merchantUuid": merchant_uuid, "url": image_url} for key in keys]
    ...
    def test_066_api_78dk_platform_mm_base_store_uploadQrcode(self):
        ...
        :return:
        """
        PlatformAction.test_api_78dk_platform_mm_base_store_uploadQrcode(merchant_uuid)
    ...
    def test_067_api_78dk_platform_mm_base_store_saveStore(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_mm_base_store_saveStore(businessaddress='经营地址',
            businessaddressgpsloction='', managername=store_name, managerphone=mobile, merchantuuid=merchant_uuid,
            storeuuid="", storename='', province=510000, city=510100, region=510104, provincename='', cityname='',
            regionname='', idcardnumber='', numberbegindate='2019-01-01', numberenddate='2019-01-01',
            leasetimeend='2019-01-01', area='100', email=email, employeesnum='10', leasetimebegin='2019-01-01')
        Assertion.verity(json.loads(res)['code'], '20000')
        Assertion.verity(json.loads(res)['msg'], '请输入门店名称')

    @unittest.skip('接口已废弃')
    def test_062_api_78dk_platform_mm_range_findMMRByMerchantUuid(self):
        """
        通过商户uuid查询商户经营范围
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_mm_range_findMMRByMerchantUuid(merchant_uuid)
        Assertion.verity(json.loads(res)['code'], '20000')
        Assertion.verity(json.loads(res)['msg'], 'StoreName不能为空!')
    ...
    def test_068_api_78dk_platform_mm_base_findOptLog(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_mm_base_findOptLog(merchant_uuid)
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    @unittest.skip('remark修改成不是必填项，不再断言验证')
    def test_065_api_78dk_platform_mm_bd_saveBDMerchant_remark_none(self):
        """
        新增商户BD信息
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_mm_bd_saveBDMerchant(bdinfouuid=bdinfouuid,
            merchantuuid=merchant_uuid, name=bd_name, remark='')
        Assertion.verity(json.loads(res)['code'], '20000')
        Assertion.verity(json.loads(res)['msg'], '备注不能为空!')
    ...
    def test_071_api_78dk_platform_mm_bd_saveBDMerchant_merchantuuid_none(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_mm_bd_saveBDMerchant(bdinfouuid=bdinfouuid, merchantuuid='',
    ...
    def test_072_api_78dk_platform_mm_bd_saveBDMerchant_bdInfoUuid_none(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_mm_bd_saveBDMerchant(bdinfouuid='', merchantuuid=merchant_uuid,
            name=bd_name, remark='123')
        Assertion.verity(json.loads(res)['code'], '20000')
    ...
    def test_073_api_78dk_platform_mm_bd_saveBDMerchant(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_mm_bd_saveBDMerchant(bdinfouuid=bdinfouuid,
            merchantuuid=merchant_uuid, name=bd_name, remark='123')
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_074_api_78dk_platform_mm_bd_findBDMerchant_none(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_mm_bd_findBDMerchant(uid='')
        Assertion.verity(json.loads(res)['code'], '20000')
        Assertion.verity(json.loads(res)['msg'], 'MerchantUuid不能为空!')
    ...
    def test_075_api_78dk_platform_mm_bd_findBDMerchant(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_mm_bd_findBDMerchant(uid=merchant_uuid)
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_076_api_78dk_platform_om_bd_addBdInfo(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_om_bd_addBdInfo(channeluuid=channelid, email=email2, mobile=mobile2,
            name=bd_name2)
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
        global bdinfouuid2
    ...
    @unittest.skip('remark修改成不是必填项，不再断言验证')
    def test_073_api_78dk_platform_mm_bd_updateBDMerchant_remark_none(self):
        """
        修改商户BD信息
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_mm_bd_updateBDMerchant(bdinfouuid=bdinfouuid2,
            merchantuuid=merchant_uuid, name=bd_name2, remark='')
        Assertion.verity(json.loads(res)['code'], '20000')
        Assertion.verity(json.loads(res)['msg'], '备注不能为空!')
    ...
    def test_077_api_78dk_platform_mm_bd_updateBDMerchant_name_none(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_mm_bd_updateBDMerchant(bdinfouuid=bdinfouuid,
            merchantuuid=merchant_uuid, name='', remark='123')
        Assertion.verity(json.loads(res)['code'], '20000')
        Assertion.verity(json.loads(res)['msg'], '姓名不能为空!')
    ...
    def test_078_api_78dk_platform_mm_bd_updateBDMerchant_merchantuuid_none(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_mm_bd_updateBDMerchant(bdinfouuid=bdinfouuid2, merchantuuid='',
    ...
    def test_079_api_78dk_platform_mm_bd_updateBDMerchant_bdinfouuid_none(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_mm_bd_updateBDMerchant(bdinfouuid='', merchantuuid=merchant_uuid,
            name=bd_name2, remark='123')
        Assertion.verity(json.loads(res)['code'], '20000')
        Assertion.verity(json.loads(res)['msg'], 'BdInfoUuid不能为空!')
    ...
    def test_080_api_78dk_platform_mm_bd_updateBDMerchant(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_mm_bd_updateBDMerchant(bdinfouuid=bdinfouuid2,
            merchantuuid=merchant_uuid, name=bd_name2, remark='123')
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_081_api_78dk_platform_mm_examine_merchanrExamine_fail(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_mm_examine_merchanrExamine(type='fail', message='不通过',
                                                                               uid=merchant_uuid)
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_082_api_78dk_platform_mm_base_store_saveStore_examine_fail(self):
        ...
        res = PlatformAction.test_api_78dk_platform_mm_base_store_saveStore(businessaddress='经营地址',
            businessaddressgpsloction='', managername=store_name, managerphone=mobile, merchantuuid=merchant_uuid,
            storeuuid="", storename='', province=510000, city=510100, region=510104, provincename='', cityname='',
            regionname='', idcardnumber='', numberbegindate='', numberenddate='', leasetimeend='', area='', email='',
    ...
    def test_084_api_78dk_platform_mm_state_updateOpenCloseState_close(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_mm_state_updateOpenCloseState(uid=merchant_uuid,
                                                                                  updatestate='close')
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_091_api_78dk_platform_mm_examine_createTemporaryCode(self):
        ...
        desc       : 生成临时编码-v1.4
        """
        res = PlatformAction.test_api_78dk_platform_mm_examine_createTemporaryCode(uid=merchant_uuid)
        Assertion.verity(json.loads(res)['code'], '10000')

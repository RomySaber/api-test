...
class test_001_web_Channel(TestBaseCase):
    ...
    def test_12_api_78dk_platform_cm_state_updateFreezeState_freeze(self):
        ...
        res = PlatformAction.test_api_78dk_platform_cm_state_updateFreezeState(updatestate='freeze', uid=channelid)
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_13_api_78dk_platform_cm_state_updateFreezeState_normal(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_cm_state_updateFreezeState(updatestate='normal', uid=channelid)
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_19_api_78dk_platform_cm_state_updateFreezeState_freeze(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_cm_state_updateFreezeState(uid=channelid, updatestate='freeze')
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_46_api_78dk_platform_common_viewProvinceLists(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_common_viewProvinceLists(paramsingle='')
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_47_api_78dk_platform_common_viewCityLists(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_common_viewCityLists(paramsingle='110000')
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verityContain(json.loads(res)['data'], 'code')
    ...
    def test_48_api_78dk_platform_common_viewRegionLists(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_common_viewRegionLists(paramsingle='110100')
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verityContain(json.loads(res)['data'], 'code')

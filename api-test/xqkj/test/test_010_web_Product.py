...
class test_010_web_Product(TestBaseCase):
    ...
    def test_005_api_78dk_platform_product_base_saveProductEarlySettle(self):
        ...
        res = PlatformAction.test_api_78dk_platform_product_base_saveProductEarlySettle(earlysettledays="",
            earlysettlefredays='', earlysettlefrerate='', earlysettleinterest="",
            earlysettlesupport="early_repayment_support_no", earlysettlevoidmode="",
            productdetailuuid=product_detail_uuid, productearlysettleuuid='')
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_038_api_78dk_platform_product_base_saveProductEarlySettle_all_none(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_product_base_saveProductEarlySettle(earlysettledays='',
            earlysettlefredays='', earlysettlefrerate='', earlysettleinterest='', earlysettlesupport='',
            earlysettlevoidmode='', productdetailuuid='', productearlysettleuuid='')
        Assertion.verity(json.loads(res)['code'], '20000')
    ...
    def test_039_api_78dk_platform_product_base_saveProductEarlySettle_support_unknown(self):
        ...
        res = PlatformAction.test_api_78dk_platform_product_base_saveProductEarlySettle(earlysettledays="",
        earlysettlefredays='', earlysettlefrerate='', earlysettleinterest="",
        earlysettlesupport="early_repayment_support_unknown", earlysettlevoidmode="",
        productdetailuuid=product_detail_uuid, productearlysettleuuid='')
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_040_api_78dk_platform_product_base_saveProductEarlySettle_earlysettledays_error(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_product_base_saveProductEarlySettle(earlysettledays=-1,
        earlysettlefredays='', earlysettlefrerate='', earlysettleinterest="early_settle_interest_free",
        earlysettlesupport="early_repayment_support_yes", earlysettlevoidmode="early_settle_void_mode_free",
        productdetailuuid=product_detail_uuid, productearlysettleuuid='')
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_041_api_78dk_platform_product_base_saveProductEarlySettle_earlysettledays_not_num(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_product_base_saveProductEarlySettle(earlysettledays='abc',
        earlysettlefredays='', earlysettlefrerate='', earlysettleinterest="early_settle_interest_free",
        earlysettlesupport="early_repayment_support_yes", earlysettlevoidmode="early_settle_void_mode_free",
        productdetailuuid=product_detail_uuid, productearlysettleuuid='')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_042_api_78dk_platform_product_base_saveProductEarlySettle_earlysettledays_max(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_product_base_saveProductEarlySettle(earlysettledays=99999999999,
        earlysettlefredays='', earlysettlefrerate='', earlysettleinterest="early_settle_interest_free",
        earlysettlesupport="early_repayment_support_yes", earlysettlevoidmode="early_settle_void_mode_free",
        productdetailuuid=product_detail_uuid, productearlysettleuuid='')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_043_api_78dk_platform_product_base_saveProductEarlySettle_earlysettledays_zero(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_product_base_saveProductEarlySettle(earlysettledays=0,
        earlysettlefredays='', earlysettlefrerate='', earlysettleinterest="early_settle_interest_free",
        earlysettlesupport="early_repayment_support_yes", earlysettlevoidmode="early_settle_void_mode_free",
        productdetailuuid=product_detail_uuid, productearlysettleuuid='')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_044_api_78dk_platform_product_base_saveProductEarlySettle_interest_unknown(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_product_base_saveProductEarlySettle(earlysettledays=1,
        earlysettlefredays='', earlysettlefrerate='', earlysettleinterest="early_settle_interest_unknown",
        earlysettlesupport="early_repayment_support_yes", earlysettlevoidmode="early_settle_void_mode_free",
        productdetailuuid=product_detail_uuid, productearlysettleuuid='')
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_045_api_78dk_platform_product_base_saveProductEarlySettle_interest_only_month(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_product_base_saveProductEarlySettle(earlysettledays=1,
        earlysettlefredays='', earlysettlefrerate='', earlysettleinterest="early_settle_interest_only_month",
        earlysettlesupport="early_repayment_support_yes", earlysettlevoidmode="early_settle_void_mode_free",
        productdetailuuid=product_detail_uuid, productearlysettleuuid='')
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_046_api_78dk_platform_product_base_saveProductEarlySettle_interest_normal(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_product_base_saveProductEarlySettle(earlysettledays=1,
        earlysettlefredays='', earlysettlefrerate='', earlysettleinterest="early_settle_interest_normal",
        earlysettlesupport="early_repayment_support_yes", earlysettlevoidmode="early_settle_void_mode_free",
        productdetailuuid=product_detail_uuid, productearlysettleuuid='')
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_048_api_78dk_platform_product_base_saveProductEarlySettle_mode_unknown(self):
        ...
        res = PlatformAction.test_api_78dk_platform_product_base_saveProductEarlySettle(earlysettledays=1,
        earlysettlefredays='', earlysettlefrerate='', earlysettleinterest="early_settle_interest_free",
        earlysettlesupport="early_repayment_support_yes", earlysettlevoidmode="early_settle_void_mode_unknown",
        productdetailuuid=product_detail_uuid, productearlysettleuuid='')
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_049_api_78dk_platform_product_base_saveProductEarlySettle_mode_period_free_none(self):
        ...
        res = PlatformAction.test_api_78dk_platform_product_base_saveProductEarlySettle(earlysettledays=1,
        earlysettlefredays='', earlysettlefrerate='', earlysettleinterest="early_settle_interest_free",
        earlysettlesupport="early_repayment_support_yes", earlysettlevoidmode="early_settle_void_mode_period_free",
        productdetailuuid=product_detail_uuid, productearlysettleuuid='')
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_050_api_78dk_platform_product_base_saveProductEarlySettle_mode_period_earlysettlefredays_none(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_product_base_saveProductEarlySettle(earlysettledays=1,
        earlysettlefredays='', earlysettlefrerate='1', earlysettleinterest="early_settle_interest_free",
        earlysettlesupport="early_repayment_support_yes", earlysettlevoidmode="early_settle_void_mode_period_free",
        productdetailuuid=product_detail_uuid, productearlysettleuuid='')
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_051_api_78dk_platform_product_base_saveProductEarlySettle_mode_period_earlysettlefredays_not_num(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_product_base_saveProductEarlySettle(earlysettledays=1,
        earlysettlefredays='abc', earlysettlefrerate='1', earlysettleinterest="early_settle_interest_free",
        earlysettlesupport="early_repayment_support_yes", earlysettlevoidmode="early_settle_void_mode_period_free",
        productdetailuuid=product_detail_uuid, productearlysettleuuid='')
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_052_api_78dk_platform_product_base_saveProductEarlySettle_mode_period_earlysettlefredays_max(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_product_base_saveProductEarlySettle(earlysettledays=1,
        earlysettlefredays=9999999999, earlysettlefrerate='1', earlysettleinterest="early_settle_interest_free",
        earlysettlesupport="early_repayment_support_yes", earlysettlevoidmode="early_settle_void_mode_period_free",
        productdetailuuid=product_detail_uuid, productearlysettleuuid='')
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_053_api_78dk_platform_product_base_saveProductEarlySettle_mode_period_earlysettlefredays_min(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_product_base_saveProductEarlySettle(earlysettledays=1,
        earlysettlefredays=0.0000000001, earlysettlefrerate='1', earlysettleinterest="early_settle_interest_free",
        earlysettlesupport="early_repayment_support_yes", earlysettlevoidmode="early_settle_void_mode_period_free",
        productdetailuuid=product_detail_uuid, productearlysettleuuid='')
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_054_api_78dk_platform_product_base_saveProductEarlySettle_mode_period_earlysettlefredays_error(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_product_base_saveProductEarlySettle(earlysettledays=1,
        earlysettlefredays=-1, earlysettlefrerate='1', earlysettleinterest="early_settle_interest_free",
        earlysettlesupport="early_repayment_support_yes", earlysettlevoidmode="early_settle_void_mode_period_free",
        productdetailuuid=product_detail_uuid, productearlysettleuuid='')
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_055_api_78dk_platform_product_base_saveProductEarlySettle_mode_period_earlysettlefredays_zero(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_product_base_saveProductEarlySettle(earlysettledays=1,
        earlysettlefredays=0, earlysettlefrerate='1', earlysettleinterest="early_settle_interest_free",
        earlysettlesupport="early_repayment_support_yes", earlysettlevoidmode="early_settle_void_mode_period_free",
        productdetailuuid=product_detail_uuid, productearlysettleuuid='')
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_056_api_78dk_platform_product_base_saveProductEarlySettle_mode_period_earlysettlefrerate_none(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_product_base_saveProductEarlySettle(earlysettledays=1,
        earlysettlefredays=1, earlysettlefrerate='', earlysettleinterest="early_settle_interest_free",
        earlysettlesupport="early_repayment_support_yes", earlysettlevoidmode="early_settle_void_mode_period_free",
        productdetailuuid=product_detail_uuid, productearlysettleuuid='')
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_057_api_78dk_platform_product_base_saveProductEarlySettle_mode_period_earlysettlefrerate_not_num(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_product_base_saveProductEarlySettle(earlysettledays=1,
        earlysettlefredays=1, earlysettlefrerate='abc', earlysettleinterest="early_settle_interest_free",
        earlysettlesupport="early_repayment_support_yes", earlysettlevoidmode="early_settle_void_mode_period_free",
        productdetailuuid=product_detail_uuid, productearlysettleuuid='')
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_058_api_78dk_platform_product_base_saveProductEarlySettle_mode_period_earlysettlefrerate_max(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_product_base_saveProductEarlySettle(earlysettledays=1,
        earlysettlefredays=1, earlysettlefrerate=9999999999, earlysettleinterest="early_settle_interest_free",
        earlysettlesupport="early_repayment_support_yes", earlysettlevoidmode="early_settle_void_mode_period_free",
        productdetailuuid=product_detail_uuid, productearlysettleuuid='')
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_060_api_78dk_platform_product_base_saveProductEarlySettle_mode_period_earlysettlefrerate_zero(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_product_base_saveProductEarlySettle(earlysettledays=1,
        earlysettlefredays=1, earlysettlefrerate=0, earlysettleinterest="early_settle_interest_free",
        earlysettlesupport="early_repayment_support_yes", earlysettlevoidmode="early_settle_void_mode_period_free",
        productdetailuuid=product_detail_uuid, productearlysettleuuid='')
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_061_api_78dk_platform_product_base_saveProductEarlySettle_mode_period_earlysettlefrerate_min(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_product_base_saveProductEarlySettle(earlysettledays=1,
        earlysettlefredays=1, earlysettlefrerate=0.0000000001, earlysettleinterest="early_settle_interest_free",
        earlysettlesupport="early_repayment_support_yes", earlysettlevoidmode="early_settle_void_mode_period_free",
        productdetailuuid=product_detail_uuid, productearlysettleuuid='')
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_063_api_78dk_platform_product_base_saveProductEarlySettle_productdetailuuid_none(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_product_base_saveProductEarlySettle(earlysettledays='10',
            earlysettlefredays='10', earlysettlefrerate='10', earlysettleinterest='early_settle_interest__unknown',
            earlysettlesupport='early_settle_support_unknown', earlysettlevoidmode='early_settle_void_mode_unknown',
            productdetailuuid='', productearlysettleuuid='')
        Assertion.verity(json.loads(res)['code'], '20000')
        Assertion.verity(json.loads(res)['msg'], '产品uuid不能为空!')
    ...
    def test_064_api_78dk_platform_product_base_saveProductEarlySettle_productdetailuuid_not_exits(self):
        ...
        res = PlatformAction.test_api_78dk_platform_product_base_saveProductEarlySettle(earlysettledays='10',
            earlysettlefredays='10', earlysettlefrerate='10', earlysettleinterest='early_settle_interest__unknown',
            earlysettlesupport='early_settle_support_unknown', earlysettlevoidmode='early_settle_void_mode_unknown',
            productdetailuuid='123', productearlysettleuuid='')
        Assertion.verity(json.loads(res)['code'], '20000')
    ...
    def test_065_api_78dk_platform_product_base_saveProductEarlySettle_productearlysettleuuid_not_exits(self):
        ...
        res = PlatformAction.test_api_78dk_platform_product_base_saveProductEarlySettle(earlysettledays='10',
            earlysettlefredays='10', earlysettlefrerate='10', earlysettleinterest='early_settle_interest__unknown',
            earlysettlesupport='early_settle_support_unknown', earlysettlevoidmode='early_settle_void_mode_unknown',
            productdetailuuid=product_detail_uuid, productearlysettleuuid='123')
        Assertion.verity(json.loads(res)['code'], '20000')
    ...
    def test_066_api_78dk_platform_product_base_saveProductEarlySettle_earlysettleinterest_error(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_product_base_saveProductEarlySettle(earlysettledays=1,
        earlysettlefredays=1, earlysettlefrerate=1, earlysettleinterest="123",
        earlysettlesupport="early_repayment_support_yes", earlysettlevoidmode="early_settle_void_mode_period_free",
        productdetailuuid=product_detail_uuid, productearlysettleuuid='')
        Assertion.verity(json.loads(res)['code'], '20000')
    ...
    def test_067_api_78dk_platform_product_base_saveProductEarlySettle_earlysettlevoidmode_error(self):
        ...
        res = PlatformAction.test_api_78dk_platform_product_base_saveProductEarlySettle(earlysettledays=1,
        earlysettlefredays=1, earlysettlefrerate=1, earlysettleinterest="early_settle_interest_free",
        earlysettlesupport="early_repayment_support_yes", earlysettlevoidmode="123",
        productdetailuuid=product_detail_uuid, productearlysettleuuid='')
        Assertion.verity(json.loads(res)['code'], '20000')
        Assertion.verity(json.loads(res)['msg'], '保存产品提前结清业务信息出错!')
    ...
    def test_068_api_78dk_platform_product_base_saveProductEarlySettle_earlysettlesupport_error(self):
        ...
        res = PlatformAction.test_api_78dk_platform_product_base_saveProductEarlySettle(earlysettledays=1,
        earlysettlefredays=1, earlysettlefrerate=1, earlysettleinterest="early_settle_interest_free",
        earlysettlesupport="123", earlysettlevoidmode="early_settle_void_mode_period_free",
        productdetailuuid=product_detail_uuid, productearlysettleuuid='')
        Assertion.verity(json.loads(res)['code'], '20000')
        Assertion.verity(json.loads(res)['msg'], '保存产品提前结清业务信息出错!')
    ...
    def test_069_api_78dk_platform_product_base_saveProductEarlySettle(self):
        ...
        earlysettlefredays=1, earlysettlefrerate=1, earlysettleinterest="early_settle_interest_free",
        earlysettlesupport="early_repayment_support_yes", earlysettlevoidmode="early_settle_void_mode_period_free",
        productdetailuuid=product_detail_uuid, productearlysettleuuid=productEarlySettleUuid)
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_070_api_78dk_platform_product_base_viewProductEarlySettle_none(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_product_base_queryProductEarlySettleByProductDetailUuid(
            productdetailuuid='')
        Assertion.verity(json.loads(res)['code'], '20000')
        Assertion.verity(json.loads(res)['msg'], '产品uuid不能为空!')

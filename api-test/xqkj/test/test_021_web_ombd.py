...
class test_021_web_ombd(TestBaseCase):
    def test_001_api_78dk_platform_om_bd_addBdInfo_channeluuid_none(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_om_bd_addBdInfo(channeluuid='', email=email, mobile=mobile,
            name=bd_name)
        Assertion.verity(json.loads(res)['code'], '20000')
        Assertion.verity(json.loads(res)['msg'], '渠道uuid 不能为空!')
    ...
    def test_002_api_78dk_platform_om_bd_addBdInfo_channeluuid_error(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_om_bd_addBdInfo(channeluuid='-1', email=email, mobile=mobile,
            name=bd_name)
        Assertion.verity(json.loads(res)['code'], '20000')
        Assertion.verity(json.loads(res)['msg'], '渠道uuid不合法!')
    ...
    def test_003_api_78dk_platform_om_bd_addBdInfo_email_none(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_om_bd_addBdInfo(channeluuid='-1', email='', mobile=mobile,
            name=bd_name)
        Assertion.verity(json.loads(res)['code'], '20000')
    ...
    def test_004_api_78dk_platform_om_bd_addBdInfo_mobile_none(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_om_bd_addBdInfo(channeluuid='-1', email=email, mobile='',
            name=bd_name)
        Assertion.verity(json.loads(res)['code'], '20000')
    ...
    def test_006_api_78dk_platform_om_bd_addBdInfo_256email(self):
        ...
        res = PlatformAction.test_api_78dk_platform_om_bd_addBdInfo(channeluuid=channelid, email=MockData.words_cn(256),
    ...
    def test_009_api_78dk_platform_om_bd_addBdInfo_email_error(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_om_bd_addBdInfo(channeluuid=channelid, email=MockData.words_cn(10),
            mobile=mobile, name=bd_name)
        Assertion.verity(json.loads(res)['code'], '20000')
        Assertion.verity(json.loads(res)['msg'], '邮箱的格式不合法,')
    ...
    def test_013_api_78dk_platform_om_bd_findBdInfoList(self):
        ...
        """
        res = json.loads(
            PlatformAction.test_api_78dk_platform_om_bd_findBdInfoList(bdstate='', enddate='', pagecurrent=1,
    ...
    def test_014_api_78dk_platform_om_bd_updateBdInfoState_bdstate_none(self):
        ...
        """
        res = json.loads(
            PlatformAction.test_api_78dk_platform_om_bd_updateBdInfoState(bdinfouuid=bdinfouuid, bdstate=""))
    ...
    def test_015_api_78dk_platform_om_bd_updateBdInfoState_bdinfouuid_none(self):
        ...
        """
        res = json.loads(
            PlatformAction.test_api_78dk_platform_om_bd_updateBdInfoState(bdinfouuid='', bdstate="bd_state_dimission"))
        Assertion.verity(res['code'], '20000')
    ...
    def test_016_api_78dk_platform_om_bd_updateBdInfoState_bdinfouuid_error(self):
        ...
        :return:
        """
        res = json.loads(PlatformAction.test_api_78dk_platform_om_bd_updateBdInfoState(bdinfouuid='-1',
    ...
    def test_017_api_78dk_platform_om_bd_updateBdInfoState_bdstate_error(self):
        ...
        """
        res = json.loads(
            PlatformAction.test_api_78dk_platform_om_bd_updateBdInfoState(bdinfouuid=bdinfouuid, bdstate="1"))
        Assertion.verity(res['code'], '20000')
    ...
    def test_018_api_78dk_platform_om_bd_updateBdInfoState_bd_state_dimission(self):
        ...
        :return:
        """
        res = json.loads(PlatformAction.test_api_78dk_platform_om_bd_updateBdInfoState(bdinfouuid=bdinfouuid,
            bdstate="bd_state_dimission"))
        Assertion.verity(res['code'], '10000')
        Assertion.verity(res['msg'], '成功')
    ...
    def test_020_api_78dk_platform_om_bd_findBdMerchantList(self):
        ...
        :return:
        """
        res = json.loads(PlatformAction.test_api_78dk_platform_om_bd_findBdMerchantList(bdinfouuid=bdinfouuid))
        Assertion.verity(res['code'], '10000')
        Assertion.verity(res['msg'], '成功')
    ...
    def test_021_api_78dk_platform_om_bd_findBdMerchantList_none(self):
        ...
        :return:
        """
        res = json.loads(PlatformAction.test_api_78dk_platform_om_bd_findBdMerchantList(bdinfouuid=''))
        Assertion.verity(res['code'], '20000')
        Assertion.verity(res['msg'], 'BdInfoUuid 不能为空!')
    ...
    def test_022_api_78dk_platform_om_bd_queryBdInfoLog_none(self):
        ...
        :return:
        """
        res = json.loads(PlatformAction.test_api_78dk_platform_om_bd_queryBdInfoLog(bdinfouuid=''))
    ...
    def test_023_api_78dk_platform_om_bd_queryBdInfoLog(self):
        ...
        :return:
        """
        res = json.loads(PlatformAction.test_api_78dk_platform_om_bd_queryBdInfoLog(bdinfouuid=bdinfouuid))
        Assertion.verity(res['code'], '10000')
        Assertion.verity(res['msg'], '成功')
    ...
    def test_024_api_78dk_platform_om_bd_findBdInfoList_bd_state_unknown(self):
        ...
        res = json.loads(
            PlatformAction.test_api_78dk_platform_om_bd_findBdInfoList(bdstate='bd_state_unknown', enddate='',
    ...
    def test_025_api_78dk_platform_om_bd_findBdInfoList_bd_state_dimission(self):
        ...
        res = json.loads(
            PlatformAction.test_api_78dk_platform_om_bd_findBdInfoList(bdstate='bd_state_dimission', enddate='',
                pagecurrent=1, pagesize=10, searchwhere='', startdate=""))
        Assertion.verity(res['code'], '10000')
        Assertion.verity(res['msg'], '成功')
    ...
    def test_026_api_78dk_platform_om_bd_findBdInfoList_bd_state_enabled(self):
        ...
        res = json.loads(
            PlatformAction.test_api_78dk_platform_om_bd_findBdInfoList(bdstate='bd_state_enabled', enddate='',
                pagecurrent=1, pagesize=10, searchwhere='', startdate=""))
        Assertion.verity(res['code'], '10000')
        Assertion.verity(res['msg'], '成功')
    ...
    def test_028_api_78dk_platform_om_bd_findBdInfoList_date(self):
        ...
        res = json.loads(PlatformAction.test_api_78dk_platform_om_bd_findBdInfoList(bdstate='bd_state_unknown',
    ...
    def test_029_api_78dk_platform_om_bd_bdTj(self):
        ...
        res = json.loads(
            PlatformAction.test_api_78dk_platform_om_bd_bdTj(bdstate='', enddate='', pagecurrent=1, pagesize=10,
    ...
    def test_030_api_78dk_platform_om_bd_bdTj_bd_state_unknown(self):
        ...
        res = json.loads(
            PlatformAction.test_api_78dk_platform_om_bd_bdTj(bdstate='bd_state_unknown', enddate='', pagecurrent=1,
                pagesize=10, searchwhere='', startdate=""))
        Assertion.verity(res['code'], '10000')
        Assertion.verity(res['msg'], '成功')
    ...
    def test_031_api_78dk_platform_om_bd_bdTj_bd_state_dimission(self):
        ...
        res = json.loads(
            PlatformAction.test_api_78dk_platform_om_bd_bdTj(bdstate='bd_state_dimission', enddate='', pagecurrent=1,
                pagesize=10, searchwhere='', startdate=""))
        Assertion.verity(res['code'], '10000')
        Assertion.verity(res['msg'], '成功')
    ...
    def test_032_api_78dk_platform_om_bd_bdTj_bd_state_enabled(self):
        ...
        res = json.loads(
            PlatformAction.test_api_78dk_platform_om_bd_bdTj(bdstate='bd_state_enabled', enddate='', pagecurrent=1,
                pagesize=10, searchwhere='', startdate=""))
        Assertion.verity(res['code'], '10000')
        Assertion.verity(res['msg'], '成功')
    ...
    def test_035_api_78dk_platform_om_bd_addBdInfo(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_om_bd_addBdInfo(channeluuid=channelid, email=email1, mobile=mobile1,
            name=bd_name1)
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
        global bdinfouuid1
    ...
    def test_036_api_78dk_platform_om_bd_replaceBdInfoMerchant(self):
        ...
        PlatformAction.test_api_78dk_platform_om_bd_replaceBdInfoMerchant(merchantuuids=merchantuuids,
    ...
    def test_037_api_78dk_platform_om_contract_downContracts(self):
        ...
        """
        res = json.loads(
            specialAction.test_api_78dk_platform_om_contract_downContracts(enddate='', orderstate='', name='',
                begindate=''))
        Assertion.verity(res['code'], '10000')
    ...
    def test_038_api_78dk_platform_om_lm_loanOperation(self):
        ...
        res = json.loads(PlatformAction.test_api_78dk_platform_om_lm_loanOperation(remarks='', urls='', bankseqid='',
    ...
    def test_039_api_78dk_platform_om_lm_findLoanModeList(self):
        ...
        """
        res = json.loads(
            PlatformAction.test_api_78dk_platform_om_lm_findLoanModeList(searchwhere='', pagecurrent=1, pagesize=10))
        Assertion.verity(res['code'], '10000')
        Assertion.verity(res['msg'], '成功')
    ...
    def test_040_api_78dk_platform_om_repayment_addRepayManualApply_userbilluuid_not_exits(self):
        ...
        """
        res = json.loads(
            PlatformAction.test_api_78dk_platform_om_repayment_addRepayManualApply(actualamt=1000, shouldrepayamt=1000,
                userbilluuid='123213'))
        Assertion.verity(res['code'], '20000')
    ...
    def test_042_api_78dk_platform_om_repayment_addRepayManualApply_actualamt_none(self):
        ...
        """
        res = json.loads(
            PlatformAction.test_api_78dk_platform_om_repayment_addRepayManualApply(actualamt='', shouldrepayamt=1000,
                userbilluuid=''))
        Assertion.verity(res['code'], '20000')
    ...
    def test_043_api_78dk_platform_om_repayment_addRepayManualApply_shouldrepayamt_none(self):
        ...
        """
        res = json.loads(
            PlatformAction.test_api_78dk_platform_om_repayment_addRepayManualApply(actualamt=1000, shouldrepayamt='',
                userbilluuid='123'))
        Assertion.verity(res['code'], '20000')
    ...
    def test_044_api_78dk_platform_om_repayment_findOneRepayBill_none(self):
        ...
        :return:
        """
        res = json.loads(PlatformAction.test_api_78dk_platform_om_repayment_findOneRepayBill(userbilluuid=''))
        Assertion.verity(res['code'], '20000')
    ...
    def test_045_api_78dk_platform_om_repayment_findOneRepayBill(self):
        ...
        :return:
        """
        res = json.loads(PlatformAction.test_api_78dk_platform_om_repayment_findOneRepayBill(userbilluuid='123'))
        Assertion.verity(res['code'], '10000')
        Assertion.verity(res['msg'], '成功')
    ...
    def test_046_api_78dk_platform_om_repayment_findManuelHistoryList(self):
        ...
        """
        res = json.loads(
            PlatformAction.test_api_78dk_platform_om_repayment_findManuelHistoryList(userbilluuid='', pagesize=10,
                pagecurrent=1))
        Assertion.verity(res['code'], '10000')
        Assertion.verity(res['msg'], '成功')
    ...
    def test_047_api_78dk_platform_om_repayment_findManuelHistoryList_not_exits(self):
        ...
        """
        res = json.loads(
            PlatformAction.test_api_78dk_platform_om_repayment_findManuelHistoryList(userbilluuid='123', pagesize=10,
                pagecurrent=1))
        Assertion.verity(res['code'], '10000')
        Assertion.verity(res['msg'], '成功')
    ...
    def test_048_api_78dk_platform_om_repayment_auditRepayManualApply_all_none(self):
        ...
        """
        res = json.loads(
            PlatformAction.test_api_78dk_platform_om_repayment_auditRepayManualApply(userbilluuid='', auditstate=''))
        Assertion.verity(res['code'], '20000')
    ...
    def test_049_api_78dk_platform_om_repayment_auditRepayManualApply_userbilluuid_not_exits(self):
        ...
        """
        res = json.loads(
            PlatformAction.test_api_78dk_platform_om_repayment_auditRepayManualApply(userbilluuid='123', auditstate=''))
        Assertion.verity(res['code'], '20000')
        Assertion.verity(res['msg'], '属性复制错误!')
    ...
    def test_050_api_78dk_platform_om_repayment_auditRepayManualApply_audit_state_fail(self):
        ...
        :return:
        """
        res = json.loads(PlatformAction.test_api_78dk_platform_om_repayment_auditRepayManualApply(userbilluuid='123',
    ...
    def test_051_api_78dk_platform_om_repayment_auditRepayManualApply_userbilluuid_none(self):
        ...
        :return:
        """
        res = json.loads(PlatformAction.test_api_78dk_platform_om_repayment_auditRepayManualApply(userbilluuid='',
            auditstate='audit_state_fail'))
        Assertion.verity(res['code'], '20000')
        Assertion.verity(res['msg'], 'userBillUuid 不能为空!')
    ...
    def test_053_api_78dk_platform_om_contract_viewTelephoneCheckInfosByContractUuid_not_exits(self):
        ...
        """
        res = json.loads(
            PlatformAction.test_api_78dk_platform_om_contract_viewTelephoneCheckInfosByContractUuid(uid='123'))
        Assertion.verity(res['code'], '20000')
    ...
    def test_054_api_78dk_platform_tm_fdd_findFDD_not_exits(self):
        ...
        :return:
        """
        res = json.loads(PlatformAction.test_api_78dk_platform_tm_fdd_findFDD(contractuuid='123'))
        Assertion.verity(res['code'], '20000')
    ...
    def test_055_api_78dk_platform_om_contract_viewContract_not_exits(self):
        ...
        :return:
        """
        res = json.loads(PlatformAction.test_api_78dk_platform_om_contract_viewContract(uid='123'))
        Assertion.verity(res['code'], '20000')
        Assertion.verity(res['msg'], '合同UUID:123不存在!')

    def test_056_api_78dk_platform_tm_first_findContractInfoSignStateWeb_not_exits(self):
        """
        修改法大大合同签署状态 修改为重签(废)
        :return:
        """
        res = json.loads(PlatformAction.test_api_78dk_platform_tm_first_findContractInfoSignStateWeb(uid='123'))
        Assertion.verity(res['code'], '20000')
        Assertion.verity(res['msg'], 'contractUuid没有查询到相应的合同!')
    ...
    def test_057_api_78dk_platform_om_contract_viewFDDInfo_not_exits(self):
        ...
        :return:
        """
        res = json.loads(PlatformAction.test_api_78dk_platform_om_contract_viewFDDInfo(uid='123'))
        Assertion.verity(res['code'], '20000')
        Assertion.verity(res['msg'], '合同UUID:123不存在!')

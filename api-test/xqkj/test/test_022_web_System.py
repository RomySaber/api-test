...
class test_022_web_System(TestBaseCase):
    ...
    def test_002_api_78dk_platform_sys_user_viewSystemUserList_name_none(self):
        ...
        """
        res = json.loads(
            PlatformAction.test_api_78dk_platform_sys_user_viewSystemUserList(name='', pagecurrent=1, pagesize=10))
        Assertion.verity(res['code'], '10000')
        Assertion.verity(res['msg'], '成功')
    ...
    def test_003_api_78dk_platform_sys_user_viewSystemUserList_not_exits(self):
        ...
        """
        res = json.loads(
            PlatformAction.test_api_78dk_platform_sys_user_viewSystemUserList(name=''.join(fake.words(nb=128)),
    ...
    def test_004_api_78dk_platform_sys_user_viewSystemUserList(self):
        ...
        """
        res = json.loads(
            PlatformAction.test_api_78dk_platform_sys_user_viewSystemUserList(name=name, pagesize=20, pagecurrent=1))
        Assertion.verity(res['code'], '10000')
        Assertion.verity(res['msg'], '成功')
    ...
    def test_007_api_78dk_platform_sys_user_updateSystemUser(self):
        ...
        :return:
        """
        res2 = PlatformAction.test_api_78dk_platform_sys_user_updateSystemUser(name=name, email=email, mobile=phone,
    ...
    def test_008_api_78dk_platform_sys_user_updateUserPass(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_sys_user_updateUserPass(password='1', passwordrepeat='1',
    ...
    def test_009_api_78dk_platform_sys_user_updateSystemUser_10_phone(self):
        ...
        :return:
        """
        res2 = PlatformAction.test_api_78dk_platform_sys_user_updateSystemUser(name=name, email=email,
                                                                               mobile='1234567890',
                                                                               platformuserprofileuuid=user_uuid)
        Assertion.verity(json.loads(res2)['code'], '20000')
    ...
    def test_011_api_78dk_platform_sys_user_updateSystemUser_phone(self):
        ...
        :return:
        """
        res2 = PlatformAction.test_api_78dk_platform_sys_user_updateSystemUser(name=name, email=email, mobile=phone3,
                                                                               platformuserprofileuuid=user_uuid)
        Assertion.verity(json.loads(res2)['code'], '10000')
        Assertion.verity(json.loads(res2)['msg'], '成功')
    ...
    def test_012_api_78dk_platform_sys_user_updateSystemUser_name(self):
        ...
        :return:
        """
        res2 = PlatformAction.test_api_78dk_platform_sys_user_updateSystemUser(name=name3, email=email, mobile=phone,
                                                                               platformuserprofileuuid=user_uuid)
        Assertion.verity(json.loads(res2)['code'], '10000')
        Assertion.verity(json.loads(res2)['msg'], '成功')
    ...
    def test_013_api_78dk_platform_sys_user_updateSystemUser_name_phone(self):
        ...
        :return:
        """
        res2 = PlatformAction.test_api_78dk_platform_sys_user_updateSystemUser(name=name4, email=email, mobile=phone4,
                                                                               platformuserprofileuuid=user_uuid)
        Assertion.verity(json.loads(res2)['code'], '10000')
        Assertion.verity(json.loads(res2)['msg'], '成功')
    ...
    def test_014_api_78dk_platform_sys_user_updateSystemUser_mail(self):
        ...
        :return:
        """
        res2 = PlatformAction.test_api_78dk_platform_sys_user_updateSystemUser(name=name, email=email3, mobile=phone4,
                                                                               platformuserprofileuuid=user_uuid)
    ...
    def test_015_api_78dk_platform_sys_user_updateSystemUserState_dimission(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_sys_user_updateSystemUserState(uid=user_uuid,
    ...
    def test_016_api_78dk_platform_sys_user_viewSystemUser_dimission(self):
        ...
        :return:
        """
        res2 = PlatformAction.test_api_78dk_platform_sys_user_viewSystemUser(paramsingle=user_uuid)
        Assertion.verity(json.loads(res2)['code'], '10000')
        Assertion.verity(json.loads(res2)['msg'], '成功')
    ...
    def test_017_api_78dk_platform_sys_user_login_dimission(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_sys_user_login(email=email, password='123456')
    ...
    def test_018_api_78dk_platform_sys_user_saveSystemUser_dimission_phone_exit(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_sys_user_saveSystemUser(email=email3, name=name, mobile=phone)
        Assertion.verity(json.loads(res)['code'], '20000')
    ...
    def test_020_api_78dk_platform_sys_user_login(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_sys_user_login(email=email, password='1')
        Assertion.verity(json.loads(res)['code'], '20000')
        Assertion.verity(json.loads(res)['msg'], '用户名或密码不正确!')
    ...
    def test_021_api_78dk_platform_sys_user_login_passerror(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_sys_user_login(email=email, password='1235456')
        Assertion.verity(json.loads(res)['code'], '20000')
        Assertion.verity(json.loads(res)['msg'], '用户名或密码不正确!')
    ...
    def test_022_api_78dk_platform_sys_user_login_usererror(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_sys_user_login(email='eed@qq.com', password='1235456')
        Assertion.verity(json.loads(res)['code'], '20000')
        Assertion.verity(json.loads(res)['msg'], '用户名或密码不正确!')
    ...
    def test_028_api_78dk_platform_sys_privilege_viewUserPrivilegeList(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_sys_privilege_viewUserPrivilegeList(platformuseruuid=user_uuid,
            permissiontype='')
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_033_api_78dk_platform_sys_user_saveSystemUser(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_sys_user_saveSystemUser(email='gggggggggg', name=name4,
            mobile=phone4)
        Assertion.verity(json.loads(res)['code'], '20000')
    ...
    def test_034_api_78dk_platform_sys_user_saveSystemUser_phone_ten(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_sys_user_saveSystemUser(email=email4, mobile='1354323456',
            name=name4)
        Assertion.verity(json.loads(res)['code'], '20000')
    ...
    def test_035_api_78dk_platform_sys_user_saveSystemUser_12_phone(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_sys_user_saveSystemUser(email=email4, mobile='135432345665',
            name=name4)
        Assertion.verity(json.loads(res)['code'], '20000')
        Assertion.verity(json.loads(res)['msg'], '手机格式不合法,')
    ...
    def test_036_api_78dk_platform_sys_user_saveSystemUser_phone_error(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_sys_user_saveSystemUser(email=email4, mobile='43543234566',
            name=name4)
        Assertion.verity(json.loads(res)['code'], '20000')
        Assertion.verity(json.loads(res)['msg'], '手机格式不合法,')
    ...
    def test_037_api_78dk_platform_sys_privilege_saveMenu(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_sys_privilege_saveMenu(url=address_report,
            platformprivilegeuuid='123', name=name_report)
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_029_api_78dk_platform_sys_user_deleteSystemUserlogin(self):
        ...
        :return:
        """
        PlatformAction.test_api_78dk_platform_sys_user_updateUserPass(password='123456', passwordrepeat='123456',
            email=email, uid=user_uuid)
        res = PlatformAction.test_api_78dk_platform_sys_user_login(email, '123456')
        Assertion.verity(json.loads(res)['code'], '20000')
        Assertion.verity(json.loads(res)['msg'], '用户名或密码不正确!')

    def test_030_api_78dk_platform_common_findQiniuToken_none(self):
        """
        获取七牛tocken
        :return:
        """
    ...
    def test_031_api_78dk_platform_common_findQiniuToken_error(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_common_findQiniuToken('123')
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_032_api_78dk_platform_common_viewImageUrl(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_common_viewImageUrl(qiniukey='', type='')
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')

    def test_033_api_78dk_platform_file_download(self):
        """
        文件下载
        :return:
        """
        PlatformAction.test_api_78dk_platform_file_download(filename='', urlstr='')

    @unittest.skip('接口已废弃')
    def test_034_FileUploadController_handlerFileUpload(self):
        """
        图片上传
        :return:
        """
        res = PlatformAction.test_FileUploadController_handlerFileUpload()
        Assertion.verity(json.loads(res)['code'], '99999')

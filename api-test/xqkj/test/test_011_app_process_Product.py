...
class test_011_app_process_Product(TestBaseCase):
    ...
    @unittest.skip('接口已废弃')
    def test_009_api_78dk_app_process_loanCalculator(self):
        """
        贷款试算
        :return:
        """
        res = json.loads(AppAction.test_api_78dk_app_process_loanCalculator(loanamount=10000, isdiscount=True,
        ...
        Assertion.verityContain(res['data'], 'period')
        Assertion.verityContain(res['data'], 'principal')
        Assertion.verityContain(res['data'], 'productDetailConfigUuid')

    @unittest.skip('接口已废弃')
    def test_010_api_78dk_app_process_loanCalculator_false(self):
        """
        贷款试算
        :return:
        """
        res = json.loads(AppAction.test_api_78dk_app_process_loanCalculator(loanamount=10000, isdiscount=False,
            productdetailuuid=productdetailuuid, storeuuid=storeuuid))
        Assertion.verity(res['code'], '10000')
        Assertion.verityContain(res['data'], 'handlingFee')
        Assertion.verityContain(res['data'], 'lastPayDate')
    ...
    @unittest.skip('接口已废弃')
    def test_011_api_78dk_app_process_loanCalculator_amount_none(self):
        """
        贷款试算
        :return:
        """
        res = json.loads(AppAction.test_api_78dk_app_process_loanCalculator(loanamount='', isdiscount=True,
            productdetailuuid=productdetailuuid, storeuuid=storeuuid))
        Assertion.verity(res['code'], '20000')
        Assertion.verity(res['msg'], '请输入分期金额！')

    @unittest.skip('接口已废弃')
    def test_012_api_78dk_app_process_loanCalculator_amount_max(self):
        """
        贷款试算
        :return:
        """
        res = json.loads(AppAction.test_api_78dk_app_process_loanCalculator(loanamount=999999999999, isdiscount=True,
            productdetailuuid=productdetailuuid, storeuuid=storeuuid))
        Assertion.verity(res['code'], '20000')

    @unittest.skip('接口已废弃')
    def test_013_api_78dk_app_process_loanCalculator_amount_not_int(self):
        """
        贷款试算
        :return:
        """
        res = json.loads(AppAction.test_api_78dk_app_process_loanCalculator(loanamount='abc', isdiscount=True,
            productdetailuuid=productdetailuuid, storeuuid=storeuuid))
        Assertion.verity(res['code'], '20000')
        Assertion.verity(res['msg'], '系统繁忙，请稍候再试')

    @unittest.skip('接口已废弃')
    def test_014_api_78dk_app_process_loanCalculator_productdetailuuid_none(self):
        """
        贷款试算
        :return:
        """
        res = json.loads(
            AppAction.test_api_78dk_app_process_loanCalculator(loanamount=10000, isdiscount=True, productdetailuuid='',
                storeuuid=storeuuid))
        Assertion.verity(res['code'], '20000')
        Assertion.verity(res['msg'], '产品期数为空！')

    @unittest.skip('接口已废弃')
    def test_015_api_78dk_app_process_loanCalculator_productdetailuuid_not_exits(self):
        """
        贷款试算
        :return:
        """
    ...
    @unittest.skip('接口已废弃')
    def test_016_api_78dk_app_process_loanCalculator_storeuuid_not_exits(self):
        """
        贷款试算
        :return:
        """
    ...
    @unittest.skip('接口已废弃')
    def test_017_api_78dk_app_process_loanCalculator_storeuuid_none(self):
        """
        贷款试算
        :return:
        """
    ...
    def test_034_api_78dk_app_process_createContract_productdetailconfiguuid_none(self):
        ...
        res = json.loads(AppAction.test_api_78dk_app_process_createContract(loanamount=10000, isdiscount=True,
            ...
            placeordergpsuuid=placeordergpsuuid))
        Assertion.verity(res['code'], '20000')
        Assertion.verity(res['msg'], '产品期数为空！')

...
class test_018_web_FirstCheck(TestBaseCase):
    ...
    def test_023_api_78dk_platform_tm_telephone_telephoneCheck_fail(self):
        ...
        res = PlatformAction.test_api_78dk_platform_tm_telephone_telephoneCheck(
    ...
    def test_033_api_78dk_platform_tm_telephone_addTelephoneCheckInfos(self):
        ...
        :return:
        """
        PlatformAction.test_api_78dk_platform_tm_telephone_addTelephoneCheckInfos(
    ...
    def test_034_api_78dk_platform_tm_telephone_deleteTelephoneCheckInfo(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_tm_telephone_deleteTelephoneCheckInfo(uid=contract_uuid)
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_036_api_78dk_platform_tm_final_finalCheck_cancel(self):
        ...
        res = PlatformAction.test_api_78dk_platform_tm_final_finalCheck(
            checkstate='终审取消', uuid=contract_uuid, message='cancel')
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_039_api_78dk_platform_tm_final_finalCheck_fail(self):
        ...
        xqkj_query.update_contract_machine_final_check(contract_uuid)
        res = PlatformAction.test_api_78dk_platform_tm_final_finalCheck(
            checkstate='终审失败', uuid=contract_uuid, message='fail')
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_042_api_78dk_platform_tm_final_finalCheck_pass(self):
        ...
        xqkj_query.update_contract_machine_final_check(contract_uuid)
        res = PlatformAction.test_api_78dk_platform_tm_final_finalCheck(
            checkstate='终审通过', uuid=contract_uuid, message='pass')
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_045_api_78dk_platform_tm_after_viewReportContract(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_tm_after_viewReportContract(contract_uuid)
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_046_api_78dk_platform_tm_after_viewContractTongDuns(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_tm_after_viewContractTongDuns(contract_uuid)
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_048_api_78dk_bm_viewUserBill(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_bm_viewUserBill(contractuuid=contract_uuid, pagecurrent=1, pagesize=10)
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_049_api_78dk_bm_viewBillList_all(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_bm_viewBillList(state='', pagecurrent=1, pagesize=10, merchantname='',
    ...
    def test_050_api_78dk_bm_viewBillList_active(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_bm_viewBillList(
    ...
    def test_051_api_78dk_platform_lm_viewContract(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_lm_viewContract(contract_uuid)
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_052_api_78dk_platform_lm_downPayMoneys(self):
        # 导出打款信息
        res = PlatformAction.test_api_78dk_platform_lm_downPayMoneys(
    ...
    def test_053_api_78dk_platform_lm_downLoans(self):
        # 导出放款列表
        res = PlatformAction.test_api_78dk_platform_lm_downLoans(
            enddate='', begindate='', contractnumber='', loanstate='', merchantname='', phone='', username='')
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_054_api_78dk_platform_lm_offLineLoan(self):
        # 放款
        res = PlatformAction.test_api_78dk_platform_lm_offLineLoan(
    ...
    def test_055_api_78dk_platform_lm_viewLoans(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_lm_viewLoans(
    ...
    def test_056_api_78dk_platform_lm_viewLoanDetil(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_lm_viewLoanDetil(contract_uuid)
        # Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_057_api_78dk_platform_lm_viewUserBill_all(self):
        ...
        :return:
        """
        res = PlatformAction.test_api_78dk_platform_lm_viewUserBill(
    ...
    def test_60_api_78dk_platform_tm_first_viewFirstCheckContract(self):
        ...
        desc       : 初审信息查询(新)
        """
        res = PlatformAction.test_api_78dk_platform_tm_first_viewFirstCheckContract(uid=contract_uuid)
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_061_api_78dk_platform_tm_first_viewFirstCheckContract_not_exist(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_tm_first_viewFirstCheckContract(uid='-1')
        Assertion.verityContain(json.loads(res)['msg'], '合同UUID:{}不存在!'.format(-1))
        Assertion.verity(json.loads(res)['code'], '20000')
    ...
    def test_062_api_78dk_platform_tm_first_viewFirstCheckContract_overlong(self):
        ...
        res = PlatformAction.test_api_78dk_platform_tm_first_viewFirstCheckContract(uid=contract_uuid1)
        Assertion.verityContain(json.loads(res)['msg'], '合同UUID:{}不存在!'.format(contract_uuid1))
        Assertion.verity(json.loads(res)['code'], '20000')
    ...
    def test_063_api_78dk_platform_tm_first_viewFirstCheckContract_id_is_null(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_tm_first_viewFirstCheckContract(uid='')
    ...
    def test_064_api_78dk_platform_tm_first_viewFirstCheckContract_id_is_None(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_tm_first_viewFirstCheckContract(uid=None)
    ...
    def test_068_api_78dk_platform_tm_first_businessbillinginformation(self):
        ...
        """
        res = specialAction.test_api_78dk_platform_tm_first_businessbillinginformation(contractuuid=contract_uuid)
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_069_api_78dk_platform_tm_first_businessbillinginformation_not_exist(self):
        ...
        """
        res = specialAction.test_api_78dk_platform_tm_first_businessbillinginformation(contractuuid=-1)
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_070_api_78dk_platform_tm_first_businessbillinginformation_overlong(self):
        ...
        """
        res = specialAction.test_api_78dk_platform_tm_first_businessbillinginformation(contractuuid=MD.number(256))
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_071_api_78dk_platform_tm_first_businessbillinginformation_contractuuid_is_null(self):
        ...
        """
        res = specialAction.test_api_78dk_platform_tm_first_businessbillinginformation(contractuuid='')

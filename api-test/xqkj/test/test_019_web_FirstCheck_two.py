...
class test_019_web_FirstCheck_two(TestBaseCase):
    ...
    def test_001_api_78dk_platform_tm_first_xuexinreport(self):
        ...
        res = specialAction.test_api_78dk_platform_tm_first_xuexinreport(contractuuid=contract_uuid)
    ...
    def test_002_api_78dk_platform_tm_first_xuexinreport_contract_uuid_is_null(self):
        ...
        """
        res = specialAction.test_api_78dk_platform_tm_first_xuexinreport(contractuuid='')
    ...
    def test_003_api_78dk_platform_tm_first_xuexinreport_contract_uuid_not_exist(self):
        ...
        """
        res = specialAction.test_api_78dk_platform_tm_first_xuexinreport(contractuuid=-1)
    ...
    def test_008_api_78dk_platform_tm_first_alipayreport(self):
        ...
        desc       : 支付宝报告 V1.3 新增
        """
        res = PlatformAction.test_api_78dk_platform_tm_first_alipayreport(contractuuid=contract_uuid)
        Assertion.verityContain(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_009_api_78dk_platform_tm_first_alipayreport_contract_uuid_is_null(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_tm_first_alipayreport(contractuuid='')
        Assertion.verityContain(json.loads(res)['msg'], '参数异常')
        Assertion.verity(json.loads(res)['code'], '20000')
    ...
    def test_010_api_78dk_platform_tm_first_alipayreport_contract_uuid_not_exist(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_tm_first_alipayreport(contractuuid=-1)
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_011_api_78dk_platform_tm_first_alipayreport_contract_uuid_overlogn(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_tm_first_alipayreport(contractuuid=MD.number(256))
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_012_api_78dk_platform_tm_bd_viewBdInfo(self):
        ...
        desc       : 查询BD信息v1.3.0
        """
        res = PlatformAction.test_api_78dk_platform_tm_bd_viewBdInfo(uid=contract_uuid)
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_013_api_78dk_platform_tm_bd_viewBdInfo_contract_uuid_is_null(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_tm_bd_viewBdInfo(uid='')
    ...
    def test_014_api_78dk_platform_tm_bd_viewBdInfo_contract_uuid_not_exist(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_tm_bd_viewBdInfo(uid=-1)
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_016_api_78dk_platform_tm_first_addContractCustomerLabel_labelcontent_is_null(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_tm_first_addContractCustomerLabel(
    ...
    def test_020_api_78dk_platform_tm_first_deleteContractCustomerLabel(self):
        ...
        res = PlatformAction.test_api_78dk_platform_tm_first_deleteContractCustomerLabel(uid=label_uuid)
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_026_api_78dk_platform_tm_first_saveImpactData_impactdata_is_null(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_tm_first_saveImpactData(contractuuid=contract_uuid, impactdata='')
        Assertion.verityContain(json.loads(res)['msg'], '参数异常')
        Assertion.verity(json.loads(res)['code'], '20000')
    ...
    def test_027_api_78dk_platform_tm_first_saveImpactData_contractuuid_not_exist(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_tm_first_saveImpactData(
    ...
    def test_032_api_78dk_platform_tm_first_saveWindControlDataSourcecontract_uuid_not_exist(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_tm_first_saveWindControlDataSource(
    ...
    def test_035_api_78dk_platform_tm_first_setSupplementState2Yes(self):
        ...
        desc       : 翻转合同补录状态为Yes
        """
        res = PlatformAction.test_api_78dk_platform_tm_first_setSupplementState2Yes(contractuuid=contract_uuid)
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_036_api_78dk_platform_tm_first_setSupplementState2Yes_not_exist(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_tm_first_setSupplementState2Yes(contractuuid=-1)
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_041_api_78dk_platform_tm_first_viewContractLabels(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_tm_first_viewContractLabels(uid=contract_uuid)
        Assertion.verityContain(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_042_api_78dk_platform_tm_first_viewContractLabels_not_exist(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_tm_first_viewContractLabels(uid=-1)
    ...
    def test_044_api_78dk_platform_tm_first_viewContractLabels_is_null(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_tm_first_viewContractLabels(uid='')
        Assertion.verityContain(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_045_api_78dk_platform_tm_first_viewContractLabels_is_None(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_tm_first_viewContractLabels(uid=None)
    ...
    def test_050_api_78dk_platform_tm_telephone_viewTelephoneCheckContract(self):
        ...
        desc       : 电核信息查询
        """
        res = PlatformAction.test_api_78dk_platform_tm_telephone_viewTelephoneCheckContract(uid=contract_uuid)
        Assertion.verityContain(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_051_api_78dk_platform_tm_telephone_viewTelephoneCheckContract_not_exist(self):
        ...
        desc       : 电核信息查询,合同不存在
        """
        res = PlatformAction.test_api_78dk_platform_tm_telephone_viewTelephoneCheckContract(uid=-1)
        Assertion.verityContain(json.loads(res)['msg'], '合同UUID:-1不存在')
        Assertion.verity(json.loads(res)['code'], '20000')
    ...
    def test_052_api_78dk_platform_tm_telephone_viewTelephoneCheckContract_is_null(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_tm_telephone_viewTelephoneCheckContract(uid='')
        Assertion.verityContain(json.loads(res)['msg'], 'ContractUuid不能为空')
        Assertion.verity(json.loads(res)['code'], '20000')
    ...
    def test_054_api_78dk_platform_tm_telephone_viewTelephoneCheckContract_is_None(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_tm_telephone_viewTelephoneCheckContract(uid=None)
        Assertion.verityContain(json.loads(res)['msg'], '系统发生内部异常')
        Assertion.verity(json.loads(res)['code'], '20000')
    ...
    def test_055_api_78dk_platform_tm_final_finalCheck_pass(self):
        ...
        desc       : 终审,不存在的合同终审通过
        """
        res = PlatformAction.test_api_78dk_platform_tm_final_finalCheck(uuid=-1, message='不存在的合同', checkstate='pass')
    ...
    def test_056_api_78dk_platform_tm_final_finalCheck_fail(self):
        ...
        desc       : 终审,不存在的合同终审打回
        """
        res = PlatformAction.test_api_78dk_platform_tm_final_finalCheck(uuid=-1, message='不存在的合同', checkstate='fail')
        Assertion.verityContain(json.loads(res)['msg'], 'ContractUuid不存在')
        Assertion.verity(json.loads(res)['code'], '20000')
    ...
    def test_057_api_78dk_platform_tm_final_finalCheck_canl(self):
        ...
        desc       : 终审,不存在的合同终审取消
        """
        res = PlatformAction.test_api_78dk_platform_tm_final_finalCheck(uuid=-1, message='不存在的合同', checkstate='cancel')
        Assertion.verityContain(json.loads(res)['msg'], 'ContractUuid不存在')
        Assertion.verity(json.loads(res)['code'], '20000')
    ...
    def test_058_api_78dk_platform_tm_final_finalCheck_return_first(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_tm_final_finalCheck(uuid=-1, message='不存在的合同',
                                                                        checkstate='return_first')
        Assertion.verityContain(json.loads(res)['msg'], 'ContractUuid不存在')
        Assertion.verity(json.loads(res)['code'], '20000')
    ...
    def test_060_api_78dk_platform_tm_machine_resultMachine(self):
        ...
        desc       : 终审,通过
        """
        message = loginAction.sign + '终审通过'
        res = PlatformAction.test_api_78dk_platform_tm_final_finalCheck(
            uuid=contract_uuid, message=message, checkstate='pass')
        Assertion.verityContain(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_061_api_78dk_platform_tm_machine_resultMachine_is_null(self):
        ...
        desc       : 机审详情,合同uuid为空
        """
        res = PlatformAction.test_api_78dk_platform_tm_machine_resultMachine(uuid='')
        Assertion.verityContain(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_062_api_78dk_platform_tm_machine_resultMachine_is_None(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_tm_machine_resultMachine(uuid=None)
        Assertion.verityContain(json.loads(res)['msg'], '参数异常')
        Assertion.verity(json.loads(res)['code'], '20000')
    ...
    def test_064_api_78dk_platform_tm_machine_resultMachine_not_exist(self):
        ...
        desc       : 机审详情,合同uuid不存在
        """
        res = PlatformAction.test_api_78dk_platform_tm_machine_resultMachine(uuid=-1)
        Assertion.verityContain(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_065_api_78dk_platform_tm_operate_operationalCheck_all(self):
        ...
        desc       : 运营审核列表查询,查询所有
        """
        res = PlatformAction.test_api_78dk_platform_tm_operate_operationalCheck(
    ...
    def test_070_api_78dk_platform_tm_operate_operationalsave_fail(self):
        ...
        res = PlatformAction.test_api_78dk_platform_tm_operate_operationalsave(
    ...
    def test_074_api_78dk_platform_tm_operate_operationAllsave_fail(self):
        ...
        """
        message = loginAction.sign + '拒绝'
        res = PlatformAction.test_api_78dk_platform_tm_operate_operationAllsave(
    ...
    def test_076_api_78dk_platform_tm_operate_viewOperateCheckContract(self):
        ...
        desc       : 运营审批信息查询
        """
        res = PlatformAction.test_api_78dk_platform_tm_operate_viewOperateCheckContract(uid=contract_uuid)
        Assertion.verityContain(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_077_api_78dk_platform_tm_operate_viewOperateCheckContract_not_exist(self):
        ...
        """
        res = PlatformAction.test_api_78dk_platform_tm_operate_viewOperateCheckContract(uid=-1)
        Assertion.verityContain(json.loads(res)['msg'], '合同UUID:-1不存在')
        Assertion.verity(json.loads(res)['code'], '20000')
    ...
    def test_080_api_78dk_platform_tm_operate_downOperationalCheck_all(self):
        ...
        """
        res = specialAction.test_api_78dk_platform_tm_operate_downOperationalCheck(begindate='', enddate='',
              name='', phone='', state='all', uuid=contract_uuid)
        # Assertion.verityContain(json.loads(res)['msg'], '成功')
        # Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_081_api_78dk_platform_tm_operate_downOperationalCheck_pass(self):
        ...
        """
        res = specialAction.test_api_78dk_platform_tm_operate_downOperationalCheck(begindate='', enddate='',
              name='', phone='', state='pass', uuid=contract_uuid)
        # Assertion.verityContain(json.loads(res)['msg'], '成功')
        # Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_082_api_78dk_platform_tm_operate_downOperationalCheck_pass_fail(self):
        ...
        """
        res = specialAction.test_api_78dk_platform_tm_operate_downOperationalCheck(begindate='', enddate='',
              name='', phone='', state='fail', uuid=contract_uuid)
        # Assertion.verityContain(json.loads(res)['msg'], '成功')
        # Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_083_api_78dk_platform_tm_operate_downOperationalCheck_pass_pending(self):
        ...
        """
        res = specialAction.test_api_78dk_platform_tm_operate_downOperationalCheck(begindate='', enddate='',
              name='', phone='', state='pending', uuid=contract_uuid)
        # Assertion.verityContain(json.loads(res)['msg'], '成功')
        # Assertion.verity(json.loads(res)['code'], '10000')

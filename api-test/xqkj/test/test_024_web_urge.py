...
from xqkj.query import xqkj_query as xq
...
class test_024_web_urge(TestBaseCase):
    def test_001_api_78dk_platform_urge_member_viewSystemMembers(self):
        """
        Time       :2019-09-27
        author     : 闫红
        desc       :查询可添加为催收人员的员工_v1.5.2
        """
        res = json.loads(PlatformAction.test_api_78dk_platform_urge_user_viewSystemMembers())
        Assertion.verity(res['code'], '10000')
        Assertion.verity(res['msg'], '成功')
        global userUuid, userEmail, userName, userPhone
        userUuid = res['data'][0]['userUuid']
        userEmail = res['data'][0]['userEmail']
        userName = res['data'][0]['userName']
        userPhone = res['data'][0]['userPhone']
        loginAction.global_dict.set(userUuid=res['data'][0]['userUuid'])
        loginAction.global_dict.set(userEmail=res['data'][0]['userEmail'])
        loginAction.global_dict.set(userName=res['data'][0]['userName'])
        loginAction.global_dict.set(userPhone=res['data'][0]['userPhone'])

    def test_002_api_78dk_platform_urge_member_addMemberUser(self):
        """
        Time       :2019-09-27
        author     : 闫红
        ...
        res = json.loads(PlatformAction.test_api_78dk_platform_urge_user_addMemberUser(useruuid=userUuid))
        Assertion.verity(res['code'], '10000')
        Assertion.verity(res['msg'], '成功')
    ...
    def test_004_api_78dk_platform_prompt_urge_manual_allocation(self):
        """
        Time       :2019-10-08
        author     : 闫红
    ...
    def test_006_api_78dk_platform_urge_member_addMemberUser_multi(self):
        """
        Time       :2019-09-27
        author     : 闫红
        ...
        res = json.loads(PlatformAction.test_api_78dk_platform_urge_user_addMemberUser(useruuid=userUuid))
        Assertion.verity(res['code'], '20000')
        Assertion.verityContain(res['msg'], '重复的提交')
    ...
    def test_009_api_78dk_platform_urge_member_addMemberUser_overlong(self):
        """
        Time       :2019-09-27
        author     : 闫红
    ...
    def test_010_api_78dk_platform_urge_member_addMemberUser_not_str(self):
        """
        Time       :2019-09-27
        author     : 闫红
    ...
    def test_011_api_78dk_platform_urge_updateDivisionState_enable(self):
        """
        Time       :2019-09-27
        author     : 闫红
        ...
        res = json.loads(PlatformAction.test_api_78dk_platform_urge_user_updateDivisionState(
            collectionuuid=collection_uuid, divisionstate='division_enabled'))
        Assertion.verity(res['code'], '10000')
        Assertion.verity(res['msg'], '成功')

    def test_012_api_78dk_platform_urge_updateDivisionState_disable(self):
        """
        Time       :2019-09-27
        author     : 闫红
    ...
    def test_013_api_78dk_platform_urge_updateDivisionState_not_exist_enable(self):
        """
        Time       :2019-09-27
        author     : 闫红
    ...
    def test_014_api_78dk_platform_urge_updateDivisionState_not_exist_disable(self):
        """
        Time       :2019-09-27
        author     : 闫红
    ...
    def test_015_api_78dk_platform_urge_updateDivisionState_null_enable(self):
        """
        Time       :2019-09-27
        author     : 闫红
    ...
    def test_016_api_78dk_platform_urge_updateDivisionState_null_disable(self):
        """
        Time       :2019-09-27
        author     : 闫红
    ...
    def test_017_api_78dk_platform_urge_updateDivisionState_overlong_enable(self):
        """
        Time       :2019-09-27
        author     : 闫红
        ...
        userUuid = MD.uuid_random(256)
        res = json.loads(PlatformAction.test_api_78dk_platform_urge_user_updateDivisionState(
            collectionuuid=userUuid, divisionstate='division_enabled'))
        Assertion.verity(res['code'], '20000')
        Assertion.verityContain(res['msg'], '传入的uuid 不合法!')

    def test_018_api_78dk_platform_urge_updateDivisionState_overlong_disable(self):
        """
        Time       :2019-09-27
        author     : 闫红
        ...
        userUuid = MD.uuid_random(256)
        res = json.loads(PlatformAction.test_api_78dk_platform_urge_user_updateDivisionState(
            collectionuuid=userUuid, divisionstate='division_disabled'))
        Assertion.verity(res['code'], '20000')
        Assertion.verityContain(res['msg'], '传入的uuid 不合法')

    def test_019_api_78dk_platform_urge_updateDivisionState_null(self):
        """
        Time       :2019-09-27
        author     : 闫红
    ...
    def test_020_api_78dk_platform_urge_updateDivisionState_overlong(self):
        """
        Time       :2019-09-27
        author     : 闫红
        ...
        res = json.loads(PlatformAction.test_api_78dk_platform_urge_user_updateDivisionState(
            collectionuuid=userUuid, divisionstate=divisionstate))
        Assertion.verity(res['code'], '20000')
        Assertion.verityContain(res['msg'], '传入的uuid 不合法')

    def test_021_api_78dk_platform_urge_collectionPersonnelList_enable(self):
        """
        Time       :2019-09-27
        author     : 闫红
        desc       :催收人员管理列表-搜索-v1.5.2,搜索分案状态为开启的所有人员
        """
        res = json.loads(PlatformAction.test_api_78dk_platform_urge_user_collectionPersonnelList(
            divisionstate='division_enabled',email='',mobile='',name='',pagesize=10,pagecurrent=1))
        Assertion.verity(res['code'], '10000')
        Assertion.verity(res['msg'], '成功')

    def test_022_api_78dk_platform_urge_collectionPersonnelList_disable(self):
        """
        Time       :2019-09-27
        author     : 闫红
    ...
    def test_023_api_78dk_platform_urge_collectionPersonnelList_null(self):
        """
        Time       :2019-09-27
        author     : 闫红
    ...
    def test_024_api_78dk_platform_urge_collectionPersonnelList_other(self):
        """
        Time       :2019-09-27
        author     : 闫红
    ...
    def test_025_api_78dk_platform_urge_collectionPersonnelList_name(self):
        """
        Time       :2019-09-27
        author     : 闫红
    ...
    def test_026_api_78dk_platform_urge_collectionPersonnelList_mobile(self):
        """
        Time       :2019-09-27
        author     : 闫红
    ...
    def test_027_api_78dk_platform_urge_collectionPersonnelList_email(self):
        """
        Time       :2019-09-27
        author     : 闫红
    ...
    def test_037_api_78dk_platform_urge_collectionPersonnelList_email(self):
        """
        Time       :2019-09-27
        author     : 闫红
        ...
        userPhone = loginAction.global_dict.get('userPhone')
        res = json.loads(PlatformAction.test_api_78dk_platform_urge_user_collectionPersonnelList(
            divisionstate='division_enabled',email=userEmail,mobile=userPhone,name=userName,pagesize=10,pagecurrent=1))
        Assertion.verity(res['code'], '10000')
        Assertion.verity(res['msg'], '成功')

    def test_038_api_78dk_platform_urge_collectionPersonnelList_email(self):
        """
        Time       :2019-09-27
        author     : 闫红
    ...
    def test_039_api_78dk_platform_urge_collectionPersonnelList_name(self):
        """
        Time       :2019-09-27
        author     : 闫红
    ...
    def test_040_api_78dk_platform_urge_collectionPersonnelList_mobile(self):
        """
        Time       :2019-09-27
        author     : 闫红
    ...
    def test_042api_78dk_platform_urge_collectionPersonnelList_email(self):
        """
        Time       :2019-09-27
        author     : 闫红
        ...
        userPhone = loginAction.global_dict.get('userPhone')
        res = json.loads(PlatformAction.test_api_78dk_platform_urge_user_collectionPersonnelList(
            divisionstate='division_disabled',email=userEmail,mobile=userPhone,name=userName,pagesize=10,pagecurrent=1))
        Assertion.verity(res['code'], '10000')
        Assertion.verity(res['msg'], '成功')

    def test_043_api_78dk_platform_urge_collectionPersonnelList_email(self):
        """
        Time       :2019-09-27
        author     : 闫红
        desc       :催收人员管理列表-搜索-v1.5.2,搜索指定手机号、指定姓名、分案状态为开启的催收人员
    ...
    def test_044_api_78dk_platform_prompt_urge_data_list(self):
        """
        Time       :2019-09-27
        author     : 闫红
        desc       :逾期用户列表v1.5.2,查询该催收员所负责的所有逾期用户列表
        """
        res = json.loads(PlatformAction.test_api_78dk_platform_prompt_urge_overdue_user(idcard='',loandatebegin='',
              loandateend='',name='',overduedaybegin='',overduedayend='',overduestage='',mobile='',
              repaymentdatebegin='',repaymentdateend='',urgeuuid=userUuid,currentpage=1,currenturge='yes',pagesize=10,totalpage=100))
        Assertion.verity(res['code'], '10000')
        Assertion.verity(res['msg'], '成功')

    def test_045_api_78dk_platform_prompt_urge_data_list(self):
        """
        Time       :2019-09-29
        author     : 闫红
        ...
        res = json.loads(PlatformAction.test_api_78dk_platform_prompt_urge_overdue_user(idcard='',loandatebegin='',
              loandateend='',name='',overduedaybegin='',overduedayend='',overduestage='',mobile='',
              repaymentdatebegin='',repaymentdateend='',urgeuuid=-1,currentpage=1,currenturge='yes',pagesize=10,totalpage=100))
        Assertion.verity(res['code'], '10000')
        Assertion.verity(res['msg'], '成功')

    def test_046_api_78dk_platform_prompt_urge_data_list(self):
        """
        Time       :2019-09-29
        author     : 闫红
        ...
        """
        res = json.loads(PlatformAction.test_api_78dk_platform_prompt_urge_overdue_user(idcard='',loandatebegin='',
              loandateend='',name='',overduedaybegin=5,overduedayend=6,overduestage='',mobile='',
              repaymentdatebegin='',repaymentdateend='',urgeuuid=-1,currentpage=1,currenturge='yes',pagesize=10,totalpage=100))
        Assertion.verity(res['code'], '10000')
        Assertion.verity(res['msg'], '成功')

    def test_047_api_78dk_platform_prompt_urge_data_list_settle(self):
        """
        Time       :2019-09-29
        author     : 闫红
    ...
    def test_048_api_78dk_platform_prompt_urge_data_list_part(self):
        """
        Time       :2019-09-29
        author     : 闫红
    ...
    def test_049_api_78dk_platform_prompt_urge_data_list_part_unknown(self):
        """
        Time       :2019-09-29
        author     : 闫红
    ...
    def test_050_api_78dk_platform_prompt_urge_data_list_part_idcard_error(self):
        """
        Time       :2019-09-29
        author     : 闫红
        ...
        """
        idcard = MD.number(22)
        res = json.loads(PlatformAction.test_api_78dk_platform_prompt_urge_overdue_user(idcard=idcard,loandatebegin='',
              loandateend='',name='',overduedaybegin='',overduedayend='',overduestage='',mobile='',
              repaymentdatebegin='',repaymentdateend='',urgeuuid=userUuid,currentpage=1,currenturge='yes',pagesize=10,totalpage=100))
        Assertion.verity(res['code'], '10000')
        Assertion.verity(res['msg'], '成功')

    def test_051_api_78dk_platform_prompt_urge_data_list_part_mobile_error(self):
        """
        Time       :2019-09-29
        author     : 闫红
        ...
        mobile = MD.number(22)
        res = json.loads(PlatformAction.test_api_78dk_platform_prompt_urge_overdue_user(idcard='',loandatebegin='',
              loandateend='',name='',overduedaybegin='',overduedayend='',overduestage='',mobile=mobile,
              repaymentdatebegin='',repaymentdateend='',urgeuuid=userUuid,currentpage=1,currenturge='yes',pagesize=10,totalpage=100))
        Assertion.verity(res['code'], '10000')
        Assertion.verity(res['msg'], '成功')

    @unittest.skip('待调试')
    def test_052_api_78dk_platform_prompt_urge_data_export(self):
        """
        Time       :2019-09-29
        author     : 闫红
        desc       :逾期用户列表导出v1.5.2
        """
        useruuids = []
        json.loads(PlatformAction.test_api_78dk_platform_prompt_urge_data_export(useruuids))

    def test_053_api_78dk_platform_urge_member_addMemberUser(self):
        """
        Time       :2019-10-10
        author     : 闫红
        desc       :将催收人员改为系统用户
        """
        xq.del_collection(userUuid)
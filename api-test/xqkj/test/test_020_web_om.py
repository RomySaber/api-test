...
class test_020_web_om(TestBaseCase):
    def test_001_api_78dk_platform_sys_user_saveSystemUser_all(self):
        ...
        """
        res = json.loads(
            PlatformAction.test_api_78dk_platform_om_contract_viewContracts(
    ...
    def test_015_api_78dk_platform_om_contract_viewFDDInfo(self):
        ...
        res = json.loads(PlatformAction.test_api_78dk_platform_om_contract_viewFDDInfo(uid=contract_uuid))
        Assertion.verity(res['code'], '10000')
    ...
    def test_016_api_78dk_platform_om_contract_viewContract(self):
        ...
        :return:
        """
        res = json.loads(PlatformAction.test_api_78dk_platform_om_contract_viewContract(uid=contract_uuid))
        Assertion.verity(res['code'], '10000')
    ...
    def test_017_api_78dk_platform_tm_first_findContractInfoSignStateWeb(self):
        ...
        :return:
        """
        res = json.loads(PlatformAction.test_api_78dk_platform_tm_first_findContractInfoSignStateWeb(uid=contract_uuid))
        Assertion.verity(res['code'], '10000')
    ...
    def test_018_api_78dk_platform_tm_first_findAuditCommentList(self):
        ...
        :return:
        """
        res = json.loads(PlatformAction.test_api_78dk_platform_tm_first_findAuditCommentList(
    ...
    def test_019_api_78dk_platform_om_contract_viewUserBill(self):
        ...
        :return:
        """
        res = json.loads(PlatformAction.test_api_78dk_platform_om_contract_viewUserBill(
    ...
    def test_020_api_78dk_platform_tm_fdd_findFDD(self):
        ...
        :return:
        """
        res = json.loads(PlatformAction.test_api_78dk_platform_tm_fdd_findFDD(contractuuid=contract_uuid))
        Assertion.verity(res['code'], '10000')
    ...
    def test_021_api_78dk_platform_om_contract_viewTongdunInfo(self):
        ...
        :return:
        """
        res = json.loads(PlatformAction.test_api_78dk_platform_om_contract_viewTongdunInfo(uid=contract_uuid))
        Assertion.verity(res['code'], '10000')
        Assertion.verity(res['msg'], '成功')
    ...
    def test_022_api_78dk_platform_om_contract_viewTelephoneCheckInfosByContractUuid(self):
        ...
        """
        res = json.loads(
            PlatformAction.test_api_78dk_platform_om_contract_viewTelephoneCheckInfosByContractUuid(uid=contract_uuid))
        Assertion.verity(res['code'], '10000')
    ...
    def test_023_api_78dk_platform_om_contract_viewBaiDuInfo(self):
        ...
        :return:
        """
        res = json.loads(PlatformAction.test_api_78dk_platform_om_contract_viewBaiDuInfo(uid=contract_uuid))
        Assertion.verity(res['code'], '20000')
    ...
    def test_025_api_78dk_platform_om_contract_viewTencentInfo(self):
        ...
        :return:
        """
        res = json.loads(PlatformAction.test_api_78dk_platform_om_contract_viewTencentInfo(uid=contract_uuid))
        Assertion.verity(res['code'], '20000')
    ...
    def test_026_api_78dk_platform_om_contract_saveErpInfo(self):
        ...
        :return:
        """
        res = json.loads(PlatformAction.test_api_78dk_platform_om_contract_saveErpInfo(
    ...
    def test_027_api_78dk_platform_om_trans_findTransLogList_all(self):
        ...
        :return:
        """
        res = json.loads(PlatformAction.test_api_78dk_platform_om_trans_findTransLogList(
    ...
    def test_045_api_78dk_platform_om_repayment_findRepaymentList_all_none(self):
        ...
        :return:
        """
        res = json.loads(PlatformAction.test_api_78dk_platform_om_repayment_findRepaymentList(
    ...
    def test_046_api_78dk_platform_om_repayment_findRepaymentList_all(self):
        ...
        res = json.loads(PlatformAction.test_api_78dk_platform_om_repayment_findRepaymentList(
            ...
            applyoptname='', pagesize=10, pagecurrent=1))
        Assertion.verity(res['code'], '10000')
        Assertion.verity(res['msg'], '成功')
    ...
    def test_051_api_78dk_platform_om_repayment_findRepaymentList_contractNumber_not_exits(self):
        ...
        res = json.loads(PlatformAction.test_api_78dk_platform_om_repayment_findRepaymentList(
            ...
            paystate="pay_state_all", applyoptname='', pagesize=10, pagecurrent=1))
        Assertion.verity(res['code'], '10000')
        Assertion.verity(res['msg'], '成功')
    ...
    def test_056_api_78dk_platform_om_repayment_findRepaymentList_applyOptName_not_exits(self):
        ...
        res = json.loads(PlatformAction.test_api_78dk_platform_om_repayment_findRepaymentList(
            ...
            paystate="pay_state_all", applyoptname='123', pagesize=10, pagecurrent=1))
        Assertion.verity(res['code'], '10000')
        Assertion.verity(res['msg'], '成功')
    ...
    def test_057_api_78dk_platform_om_repayment_findRepaymentList_applyOptName(self):
        ...
        res = json.loads(PlatformAction.test_api_78dk_platform_om_repayment_findRepaymentList(
            lastpaydateendtime='', auditstate="audit_state_all", auditoptname='', lastpaydatebegintime='',
            username='', contractnumber='', usermobile='', overduestate="overdue_state_all",
            paystate="pay_state_all", applyoptname='胡红', pagesize=10, pagecurrent=1))
        Assertion.verity(res['code'], '10000')
        Assertion.verity(res['msg'], '成功')
    ...
    def test_066_api_78dk_platform_om_repayment_findRepayment(self):
        ...
        :return:
        """
        res = json.loads(PlatformAction.test_api_78dk_platform_om_repayment_findRepayment(userbilluuid=contract_uuid))
        Assertion.verity(res['code'], '10000')
        Assertion.verity(res['msg'], '成功')
    ...
    def test_067_api_78dk_platform_om_repayment_findRepayment_not_exits(self):
        ...
        :return:
        """
        res = json.loads(PlatformAction.test_api_78dk_platform_om_repayment_findRepayment(userbilluuid='123'))
        Assertion.verity(res['code'], '10000')
        Assertion.verity(res['msg'], '成功')
    ...
    def test_068_api_78dk_platform_om_repayment_findRepaymentDetil(self):
        ...
        """
        res = json.loads(
            PlatformAction.test_api_78dk_platform_om_repayment_findRepaymentDetil(userbilluuid=contract_uuid))
        Assertion.verity(res['code'], '10000')
        Assertion.verity(res['msg'], '成功')
    ...
    def test_069_api_78dk_platform_om_repayment_findRepaymentDetil_not_exits(self):
        ...
        :return:
        """
        res = json.loads(PlatformAction.test_api_78dk_platform_om_repayment_findRepaymentDetil(userbilluuid='123'))
        Assertion.verity(res['code'], '10000')
        Assertion.verity(res['msg'], '成功')
    ...
    def test_070_api_78dk_platform_om_hmaw_addRepayManualApply(self):
        ...
        :return:
        """
        res = json.loads(PlatformAction.test_api_78dk_platform_om_hmaw_addRepayManualApply(
    ...
    def test_071_api_78dk_platform_om_repayment_addRepayUnderLineApply(self):
        ...
        :return:
        """
        res = json.loads(PlatformAction.test_api_78dk_platform_om_repayment_addRepayUnderLineApply(
    ...
    def test_074_api_78dk_platform_om_repayment_downRepaymentList(self):
        ...
        """
        res = specialAction.test_api_78dk_platform_om_repayment_downRepaymentList(applyoptname='', auditoptname='',
    ...
    def test_075_api_78dk_platform_ap_repayment_advancePayment(self):
        ...
        :return:
        """
        res = json.loads(PlatformAction.test_api_78dk_platform_ap_repayment_advancePayment(
            paydate='', remarks='', urls='', userbilluuid=''))
        Assertion.verity(res['code'], '20000')
    ...
    def test_076_api_78dk_platform_ap_repayment_findCalculate_none(self):
        ...
        :return:
        """
        res = json.loads(PlatformAction.test_api_78dk_platform_ap_repayment_findCalculate(uid=''))
        Assertion.verity(res['code'], '20000')
    ...
    def test_077_api_78dk_platform_ap_repayment_findCalculate(self):
        ...
        :return:
        """
        res = json.loads(PlatformAction.test_api_78dk_platform_ap_repayment_findCalculate(uid=contract_uuid))
        Assertion.verity(res['code'], '20000')
    ...
    def test_078_api_78dk_platform_ap_repayment_findRepaymentList_none(self):
        ...
        :return:
        """
        res = json.loads(PlatformAction.test_api_78dk_platform_ap_repayment_findRepaymentList(uid=''))
        Assertion.verity(res['code'], '20000')
    ...
    def test_079_api_78dk_platform_ap_repayment_findRepaymentList(self):
        ...
        :return:
        """
        res = json.loads(PlatformAction.test_api_78dk_platform_ap_repayment_findRepaymentList(uid=contract_uuid))
        Assertion.verity(res['code'], '10000')

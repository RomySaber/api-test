...
class testPlatform_003_Channel(TestBaseCase):
    ...
    def test_01api_78dk_platform_cm_base_saveChannel(self):
        ...
        res = PlatformAction.test_api_78dk_platform_cm_base_saveChannel(city="510100", name=channelname,
    ...
    def test_02api_78dk_platform_cm_base_updateChannel(self):
        # 编辑渠道
        res = PlatformAction.test_api_78dk_platform_cm_base_updateChannel(channeluuid=self.channelid, city="510100",
    ...
    def test_03api_78dk_platform_cm_base_viewChannel_all(self):
        # 查询渠道
        res = PlatformAction.test_api_78dk_platform_cm_base_viewChannel(self.channelid)
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_04api_78dk_platform_cm_base_viewChannel_not_exist(self):
        # 查询不存在渠道
        res = PlatformAction.test_api_78dk_platform_cm_base_viewChannel('111111111111111111111111111')
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')

    def test_05api_78dk_platform_cm_state_updateFreezeState_freeze(self):
        # 冻结渠道
        res = PlatformAction.test_api_78dk_platform_cm_state_updateFreezeState(self.channelid, 'freeze')
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')

    def test_06api_78dk_platform_cm_state_updateFreezeState_normal(self):
        # 解冻渠道
        res = PlatformAction.test_api_78dk_platform_cm_state_updateFreezeState(self.channelid, 'normal')
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')

    def test_07api_78dk_platform_cm_state_updateOpenCloseState_close(self):
        # 渠道开关状态为close
        res = PlatformAction.test_api_78dk_platform_cm_state_updateOpenCloseState(uid=self.channelid,
                                                                                  updatestate='close')
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_09api_78dk_platform_cm_examine_examine_true(self):
        # 渠道审核通过
        res = PlatformAction.test_api_78dk_platform_cm_examine_examine(isadopt='true', message='通过', uid=self.channelid)
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')

    def test_10api_78dk_platform_cm_examine_examine_false(self):
        # 渠道审核不过
        res = PlatformAction.test_api_78dk_platform_cm_base_saveChannel(city="510100", name=channelname1,
                                                                        province="510000", region="510107",
    ...
    def test_15api_78dk_platform_cm_state_viewStateChannels(self):
        # 渠道状态列表
        res = PlatformAction.test_api_78dk_platform_cm_state_viewStateChannels(
            name='', pagecurrent=1, pagesize=10, openclosestate='', freezestate='', auditstate='')
        # res = PlatformAction.test_api_78dk_platform_cm_state_viewStateChannels(name=channelname, pagecurrent=1,
        #                                                                        pagesize=10,
        #                                                                        openclosestate='open',
        #                                                                        freezestate='normal',
        #                                                                        auditstate=0)
    ...
    def test_16api_78dk_platform_cm_state_viewStateChannels_all(self):
        # 渠道状态列表全部
        res = PlatformAction.test_api_78dk_platform_cm_state_viewStateChannels(name='', pagecurrent=1, pagesize=10,
                                                                               openclosestate='',
                                                                               freezestate='',
                                                                               auditstate='')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    #     # 添加操作员
    #     res = PlatformAction.test_api_78dk_platform_cm_base_operator_saveOperator(mail='yanhong@78dk.com',
    #                                                                               mobile='15100909879',
    ...
    #     # 查询不存在的操作员
    #     res = PlatformAction.test_api_78dk_platform_cm_base_operator_viewOperator('11')
    #     Assertion.verity(json.loads(res)['code'], '10000')
    ...
    #     res = PlatformAction.test_api_78dk_platform_cm_base_operator_updateOperator(channelormerchantuuid=channelid1,
    #                                                                                 mail='dd@78dk.com',
    ...
    #     res = PlatformAction.test_api_78dk_platform_cm_base_operator_deleteOperator(operatorid)
    #     Assertion.verity(json.loads(res)['code'], '10000')
    ...
    #     res1 = PlatformAction.test_api_78dk_platform_cm_base_operator_viewOperator(
    ...
    def test_23api_78dk_platform_common_viewProvinceLists(self):
        # 省级下拉
        res = PlatformAction.test_api_78dk_platform_common_viewProvinceLists('')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_24api_78dk_platform_common_viewCityLists(self):
        # 市级下拉
        res = PlatformAction.test_api_78dk_platform_common_viewCityLists(51000)
        Assertion.verity(json.loads(res)['code'], '10000')

    def test_25api_78dk_platform_common_viewRegionLists(self):
        # 区/县级下拉
        res = PlatformAction.test_api_78dk_platform_common_viewRegionLists(51010)
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_26api_78dk_platform_cm_base_legal_saveLegalPerson(self):
        ...
        res1 = PlatformAction.test_api_78dk_platform_cm_base_legal_saveLegalPerson(cardnumber='510903199909098900',
    ...
    def test_27api_78dk_platform_cm_base_legal_viewLegalPerson(self):
        ...
        channelid = MysqlClent.select_one(loginAction.DB, 'Tbl_ChannelProfile', 'channel_uuid', sql)
        print(channelid)
        res = PlatformAction.test_api_78dk_platform_cm_base_legal_viewLegalPersonByChannel(channelid)
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_28api_78dk_platform_cm_base_legal_updateLegalPerson(self):
        ...
        res = PlatformAction.test_api_78dk_platform_cm_base_legal_updateLegalPerson(cardnumber='510903199909098900',
                                                                                    channelormerchantuuid=channelid,
    ...
    def test_29api_78dk_platform_cm_base_legal_deleteLegalPerson(self):
        ...
        # 添加渠道
        res = PlatformAction.test_api_78dk_platform_cm_base_saveChannel(city="510100", name=channelname2,
                                                                        province="510000", region="510107",
        ...
        PlatformAction.test_api_78dk_platform_cm_base_legal_saveLegalPerson(
            cardnumber='510903199909098900', channelormerchantuuid=channelid,
            legalpersonuuid='', mobile='18909890989', name=name2)
        # 删除法人代表
        sql = 'name="' + name2 + '" and state ="enabled"'
        legalpersonid = MysqlClent.select_one(loginAction.DB, 'Tbl_LegalPerson', 'legal_person_uuid', sql)
        res4 = PlatformAction.test_api_78dk_platform_cm_base_legal_deleteLegalPerson(legalpersonid)
    ...
    def test_30api_78dk_platform_cm_base_clear_saveClearingAccount(self):
        ...
        res = PlatformAction.test_api_78dk_platform_cm_base_clear_saveClearingAccount(
            accountname=namecount, accountnumber='6011826564542944', accountopeningbank='农业银行',
    ...
    def test_34api_78dk_platform_cm_base_clear_deleteClearingAccount_not_exist(self):
        # 删除结算信息---不存在
        res = PlatformAction.test_api_78dk_platform_cm_base_clear_deleteClearingAccount('123')
    ...
    def test_35api_78dk_platform_cm_base_clear_deleteClearingAccount(self):
        ...
        PlatformAction.test_api_78dk_platform_cm_base_clear_saveClearingAccount(
            accountname=namecount2, accountnumber='6011826564542944', accountopeningbank='农业银行',
            accounttype='public_accounts', branchname='支行名称', chamberlainidcard='431081199812097872',
            channelormerchantuuid=channelid1, city='510100', clearingaccountuuid='', linenumber='6756765756',
            phone='15179366892', province='510000', region='510101')
        sql = 'account_name="' + namecount2 + '" and state ="enabled"'
        clearing_account_uuid = MysqlClent.select_one(loginAction.DB, 'Tbl_ClearingAccount', 'clearing_account_uuid',
                                                      sql)
        #  删除结算信息
        res = PlatformAction.test_api_78dk_platform_cm_base_clear_deleteClearingAccount(clearing_account_uuid)
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_39api_78dk_platform_cm_base_business_deleteBusinessInfor_not_exist(self):
        # 删除不存在的机构
        res = PlatformAction.test_api_78dk_platform_cm_base_business_deleteBusinessInfor('123')
        Assertion.verity(json.loads(res)['code'], '20000')
    ...
    def test_40api_78dk_platform_cm_base_business_deleteBusinessInfor(self):
        ...
        # 删除结算
        res = PlatformAction.test_api_78dk_platform_cm_base_business_deleteBusinessInfor(businnessid)
        Assertion.verity(json.loads(res)['code'], '10000')

    def test_41_api_78dk_platform_cm_base_business_viewBusinessInforByChannel(self):
        sql = 'name="' + channelname + '" and state ="enabled"'
        channelid = MysqlClent.select_one(loginAction.DB, 'Tbl_ChannelProfile', 'channel_uuid', sql)
        res = PlatformAction.test_api_78dk_platform_cm_base_business_viewBusinessInforByChannel(channelid)
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_43_api_78dk_platform_mm_viewImageRoleList(self):
        # 影像资料权限
        sql = 'name="' + channelname + '" and state ="enabled"'
        channelid = MysqlClent.select_one(loginAction.DB, 'Tbl_ChannelProfile', 'channel_uuid', sql)
    ...
    def test_44_api_78dk_platform_mm_base_business_updateBusinessInfor(self):
        # 修改机构信息
        sql = 'name="' + channelname + '" and state ="enabled"'
        channelid = MysqlClent.select_one(loginAction.DB, 'Tbl_ChannelProfile', 'channel_uuid', sql)
    ...
    # def test_45_api_78dk_platform_mm_base_store_uploadQrcode(self):
    #     # 下载门店二维码
    #     sql = 'name="' + channelname + '" and state ="enabled"'
    #     channelid = MysqlClent.select_one(loginAction.DB, 'Tbl_ChannelProfile', 'channel_uuid', sql)
    #     res = PlatformAction.test_api_78dk_platform_mm_base_store_uploadQrcode(storeuuid=channelid)
    #     Assertion.verity(json.loads(res)['code'], '10000')
    # 
    # def test_46_api_78dk_platform_mm_range_addMerchantManagementRange(self):
    #     # 商户经营范围新增
    #     sql = 'name="' + channelname + '" and state ="enabled"'
    #     channelid = MysqlClent.select_one(loginAction.DB, 'Tbl_ChannelProfile', 'channel_uuid', sql)
    #     res = PlatformAction.test_api_78dk_platform_mm_range_addMerchantManagementRange(
    #         created='', province=510000, merchantuuid=channelid, city=510100, cityname='', updated='', provincename='')
    #     Assertion.verity(json.loads(res)['code'], '10000')
    #
    # def test_47_api_78dk_platform_mm_range_findMMRByMerchantUuid(self):
    #     # 通过商户uuid查询商户经营范围
    #     sql = 'name="' + channelname + '" and state ="enabled"'
    #     channelid = MysqlClent.select_one(loginAction.DB, 'Tbl_ChannelProfile', 'channel_uuid', sql)
    #     res = PlatformAction.test_api_78dk_platform_mm_range_findMMRByMerchantUuid(uid=channelid)
    #     Assertion.verity(json.loads(res)['code'], '10000')
    #
    # def test_48_api_78dk_platform_mm_range_deleteMerchantManagementRange(self):
    #     # 商户经营范围删除
    #     sql = 'name="' + channelname + '" and state ="enabled"'
    #     channelid = MysqlClent.select_one(loginAction.DB, 'Tbl_ChannelProfile', 'channel_uuid', sql)
    #     res = PlatformAction.test_api_78dk_platform_mm_range_deleteMerchantManagementRange(uid=channelid)
    #     Assertion.verity(json.loads(res)['code'], '10000')
    #
    # def test_49_api_78dk_platform_mm_base_business_deleteBusinessInfor(self):
    #     # 删除机构信息
    #     sql = 'name="' + channelname + '" and state ="enabled"'
    #     channelid = MysqlClent.select_one(loginAction.DB, 'Tbl_ChannelProfile', 'channel_uuid', sql)
    #     res = PlatformAction.test_api_78dk_platform_mm_base_business_deleteBusinessInfor(uid=channelid)
    #     Assertion.verity(json.loads(res)['code'], '10000')
    #
    # def test_50_api_78dk_platform_mm_base_deleteMerchant(self):
    #     # 删除基本信息
    #     sql = 'name="' + channelname + '" and state ="enabled"'
    #     channelid = MysqlClent.select_one(loginAction.DB, 'Tbl_ChannelProfile', 'channel_uuid', sql)
    #     res = PlatformAction.test_api_78dk_platform_mm_base_deleteMerchant(uid=channelid)
    #     Assertion.verity(json.loads(res)['code'], '10000')

...
from finance.testAction import ManageAction as m, loginAction
...
class testmanage(TestBaseCase):
    ...
    def test_002_company_save(self):
        ...
        desc       :保存企业
        """
        rs = m.test_company_save(id='', name=comp_name, description='', linkman=linkman, linkphone=linkphone,
    ...
    def test_004_company_lock(self):
        ...
        """
        com_id = ManageSql.get_company_id(comp_name)
        rs3 = m.test_company_lock(com_id)
    ...
    def test_006_company_update(self):
        ...
        rs5 = m.test_company_update(id=com_id, name=comp_name, description='apitest-company', linkman=linkman,
                                    linkphone=linkphone,
    ...
    def test_008_cuser_save(self):
        ...
        """
        com_id = ManageSql.get_company_id(comp_name)
        rs3 = m.test_cuser_save(id='', companyid=com_id, username=linkman, userphone=linkphone, useremail=email)
        ass.verity(json.loads(rs3)['message'], '请求成功')
    ...
    def test_009_cuser_update(self):
        ...
        com_id = ManageSql.get_company_id(comp_name)
        rs5 = m.test_cuser_update(id=user_id, companyid=com_id, username=linkman, userphone=linkphone, useremail=email)
        ass.verity(json.loads(rs5)['message'], '请求成功')
    ...
    def test_013_cuser_delete(self):
        ...
        """
        user_id = ManageSql.get_user_id(email)
        rs9 = m.test_cuser_delete(id=user_id, state='', pagesize=10, currentpage=1)
    ...
    def test_014_manage_save(self):
        ...
        desc       :新增运营人员
        """
        rs1 = m.test_manage_save(id='', managename=linkman, managephone=linkphone, manageemail=email, roleid=2)
        ass.verity(json.loads(rs1)['message'], '请求成功')
    ...
    def test_018_manage_update(self):
        ...
        """
        manage_user_id = ManageSql.get_manage_user_id(linkman)
        rs5 = m.test_manage_update(id=manage_user_id, managename=linkman, managephone=linkphone, manageemail=email,
                                   roleid=2)
        ass.verity(json.loads(rs5)['message'], '请求成功')
    ...
    def test_019_manage_lock(self):
        ...
        """
        manage_user_id = ManageSql.get_manage_user_id(linkman)
        rs6 = m.test_manage_lock(manage_user_id)
        ass.verity(json.loads(rs6)['message'], '请求成功')
    ...
    def test_022_manage_detail(self):
        ...
        rs8 = m.test_manage_detail(manage_user_id)
        ass.verity(json.loads(rs8)['message'], '请求成功')
        ass.verity(json.loads(rs8)['data']['email'], email)

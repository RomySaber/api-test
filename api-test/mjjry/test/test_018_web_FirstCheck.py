...
class test_018_web_FirstCheck(TestBaseCase):
    ...
    def test_076_risk_report(self):
        """
        author     : 罗林
        desc       : 反欺诈报告
        """
        res = WebAction.test_risk_report(contractuuid='', loanuseruuid='')
        Assertion.verity(json.loads(res)['code'], '20000')

    def test_077_api_78dk_platform_fake_fakeReport(self):
        """
        author     : 罗林
        desc       : 反欺诈报告
        """
        res = WebAction.test_api_78dk_platform_fake_fakeReport(contractuuid='', loanuseruuid='')
        Assertion.verity(json.loads(res)['code'], '20000')

...
class test_004_web_Fundside(TestBaseCase):
    def test_01_api_78dk_platform_fund_fundSide_saveFundSide_is_none(self):
        """
        添加资方 ,name为空
        :return:
        """
        res = WebAction.test_api_78dk_platform_fund_fundSide_saveFundSide(name='', state='enabled')
    ...
    def test_02_api_78dk_platform_fund_fundSide_saveFundSide_256name(self):
        ...
        :return:
        """
        res = WebAction.test_api_78dk_platform_fund_fundSide_saveFundSide(name=''.join(fake.words(nb=128)),
                                                                          state='enabled')
        Assertion.verity(json.loads(res)['code'], '20000')
    ...
    def test_03_api_78dk_platform_fund_fundSide_saveFundSide(self):
        ...
        :return:
        """
        res = WebAction.test_api_78dk_platform_fund_fundSide_saveFundSide(name=FundSidename, state='enabled')
    ...
    def test_05_api_78dk_platform_fund_fundSide_viewFundSides_all(self):
        ...
        :return:
        """
        res = WebAction.test_api_78dk_platform_fund_fundSide_viewFundSides(
    ...
    def test_07_api_78dk_platform_fund_fundSide_viewFundSide(self):
        ...
        :return:
        """
        res = WebAction.test_api_78dk_platform_fund_fundSide_viewFundSide(fundside_uuid)
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_09_api_78dk_platform_fund_fundSide_viewFundSide_not_exits(self):
        ...
        :return:
        """
        res = WebAction.test_api_78dk_platform_fund_fundSide_viewFundSide('1234564')
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_11_api_78dk_platform_fund_fundPackage_saveFundPackage_name_is_none(self):
        ...
        :return:
        """
        res = WebAction.test_api_78dk_platform_fund_fundPackage_saveFundPackage(
    ...
    def test_17_api_78dk_platform_fund_fundPackage_viewFundPackages(self):
        ...
        :return:
        """
        res = WebAction.test_api_78dk_platform_fund_fundPackage_viewFundPackages(
    ...
    def test_19_api_78dk_platform_fund_fundPackage_viewFundPackage(self):
        ...
        res = WebAction.test_api_78dk_platform_fund_fundPackage_viewFundPackage(fund_package_uuid)
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_21_api_78dk_platform_fund_fundPackage_updateFundPackage(self):
        ...
        :return:
        """
        res = WebAction.test_api_78dk_platform_fund_fundPackage_updateFundPackage(

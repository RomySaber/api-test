...
class test_020_web_om(TestBaseCase):
    ...
    def test_076_api_78dk_platform_ap_repayment_findCalculate_none(self):
        ...
        :return:
        """
        res = json.loads(WebAction.test_api_78dk_platform_ap_repayment_findCalculate(paydate='', userbilluuid=''))
        Assertion.verity(res['code'], '20000')
    ...
    def test_077_api_78dk_platform_ap_repayment_findCalculate(self):
        ...
        :return:
        """
        res = json.loads(WebAction.test_api_78dk_platform_ap_repayment_findCalculate(paydate='', userbilluuid=-1))
        Assertion.verity(res['code'], '20000')
    ...
    def test_078_api_78dk_platform_ap_repayment_findRepaymentList_none(self):
        ...
        :return:
        """
        res = json.loads(WebAction.test_api_78dk_platform_ap_repayment_findRepaymentList(paydate='', userbilluuid='abc'))
        Assertion.verity(res['code'], '20000')
    ...
    def test_079_api_78dk_platform_ap_repayment_findRepaymentList(self):
        ...
        :return:
        """
        res = json.loads(WebAction.test_api_78dk_platform_ap_repayment_findRepaymentList(paydate='2020-02-12', userbilluuid=contract_uuid))
        Assertion.verity(res['code'], '20000')

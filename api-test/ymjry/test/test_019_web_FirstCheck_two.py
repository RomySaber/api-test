...
class test_019_web_FirstCheck_two(TestBaseCase):
    ...
    def test_055_api_78dk_platform_tm_final_finalCheck_pass(self):
        ...
        desc       : 终审,不存在的合同终审通过
        """
        res = WebAction.test_api_78dk_platform_tm_final_finalCheck(uuid=-1, message='不存在的合同', checkstate='pass',
                                                                   preamount='', moneyproportion='')
    ...
    def test_056_api_78dk_platform_tm_final_finalCheck_fail(self):
        ...
        desc       : 终审,不存在的合同终审打回
        """
        res = WebAction.test_api_78dk_platform_tm_final_finalCheck(uuid=-1, message='不存在的合同', checkstate='fail',
                                                                   preamount='', moneyproportion='')
        # Assertion.verityContain(json.loads(res)['msg'], 'ContractUuid不存在')
        Assertion.verity(json.loads(res)['code'], '20000')
    ...
    def test_057_api_78dk_platform_tm_final_finalCheck_canl(self):
        ...
        desc       : 终审,不存在的合同终审取消
        """
        res = WebAction.test_api_78dk_platform_tm_final_finalCheck(uuid=-1, message='不存在的合同', checkstate='cancel',
                                                                   preamount='', moneyproportion='')
        # Assertion.verityContain(json.loads(res)['msg'], 'ContractUuid不存在')
        Assertion.verity(json.loads(res)['code'], '20000')
    ...
    def test_058_api_78dk_platform_tm_final_finalCheck_return_first(self):
        ...
        """
        res = WebAction.test_api_78dk_platform_tm_final_finalCheck(uuid=-1, message='不存在的合同',
                                                                   checkstate='return_first', preamount='', moneyproportion='')
        # Assertion.verityContain(json.loads(res)['msg'], 'ContractUuid不存在')
        Assertion.verity(json.loads(res)['code'], '20000')
    ...
    def test_059_api_78dk_platform_tm_final_finalCheck_return_second(self):
        ...
        """
        res = WebAction.test_api_78dk_platform_tm_final_finalCheck(uuid=-1, message='不存在的合同',
                                                                   checkstate='return_second', preamount='', moneyproportion='')
        Assertion.verity(json.loads(res)['code'], '20000')
    ...
    def test_060_api_78dk_platform_tm_machine_resultMachine(self):
        ...
        res = WebAction.test_api_78dk_platform_tm_final_finalCheck(
            uuid=contract_uuid, message=message, checkstate='pass', preamount='', moneyproportion='')
        Assertion.verityContain(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_080_api_78dk_platform_tm_operate_downOperationalCheck_all(self):
        ...
        """
        res = WebAction.test_api_78dk_platform_tm_operate_downOperationalCheck(begindate='', enddate='',

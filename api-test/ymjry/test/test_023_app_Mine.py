...
class test_023_app_Mine(TestBaseCase):
    ...
    def test_020_api_78dk_app_common_takeGoods_contractuuid_is_not_exist(self):
        ...
        Assertion.verityContain(json.loads(res)['msg'], '当前订单不存在！')
    ...
    def test_022_api_78dk_app_common_takeGoods_overlong(self):
        ...
        Assertion.verity(json.loads(res)['code'], '20000')
        Assertion.verity(json.loads(res)['msg'], '当前订单不存在！')
    ...
    def test_035_app_bill_getMyBill_billdate_none(self):
        ...
        author     : 罗林
        """
        res = AppAction.test_api_78dk_app_bill_getMyBill(billdate='', contractuuid=loanorderuuid)
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_037_app_bill_getMyBill_contractuuid_none(self):
        ...
        author     : 罗林
        """
        res = AppAction.test_api_78dk_app_bill_getMyBill(billdate='', contractuuid='')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_038_app_bill_getMyBill_contractuuid_not_exites(self):
        ...
        author     : 罗林
        """
        res = AppAction.test_api_78dk_app_bill_getMyBill(billdate='1574956800', contractuuid=MD.uuid_random())
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_039_bill_deferredPayment(self):
        ...
        author     : 罗林
        """
        res = AppAction.test_api_78dk_app_bill_deferredPayment(userbilluuid='-1')
        Assertion.verity(json.loads(res)['code'], 'S0003')
    ...
    def test_041_api_78dk_app_bill_repayBillOnline(self):
        """
        desc       : 线上还款(目前只支持连连主动支付)
        author     : 罗林
        """
        res = AppAction.test_api_78dk_app_bill_repayBillOnline(billuuid='', money='', type='')
        Assertion.verity(json.loads(res)['code'], '20000')

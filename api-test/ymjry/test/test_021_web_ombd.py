...
class test_021_web_ombd(TestBaseCase):
    def test_001_api_78dk_platform_om_bd_addBdInfo_channeluuid_none(self):
        ...
        :return:
        """
        res = WebAction.test_api_78dk_platform_om_bd_addBdInfo(channeluuid='', email=email, mobile=mobile,
            name=bd_name)
    ...
    def test_002_api_78dk_platform_om_bd_addBdInfo_channeluuid_error(self):
        ...
        :return:
        """
        res = WebAction.test_api_78dk_platform_om_bd_addBdInfo(channeluuid='-1', email=email, mobile=mobile,
            name=bd_name)
        Assertion.verity(json.loads(res)['code'], '20000')
    ...
    def test_003_api_78dk_platform_om_bd_addBdInfo_email_none(self):
        ...
        :return:
        """
        res = WebAction.test_api_78dk_platform_om_bd_addBdInfo(channeluuid='-1', email='', mobile=mobile,
            name=bd_name)
        Assertion.verity(json.loads(res)['code'], '20000')
    ...
    def test_004_api_78dk_platform_om_bd_addBdInfo_mobile_none(self):
        ...
        :return:
        """
        res = WebAction.test_api_78dk_platform_om_bd_addBdInfo(channeluuid='-1', email=email, mobile='',
            name=bd_name)
        Assertion.verity(json.loads(res)['code'], '20000')
    ...
    def test_006_api_78dk_platform_om_bd_addBdInfo_256email(self):
        ...
        res = WebAction.test_api_78dk_platform_om_bd_addBdInfo(channeluuid=channelid, email=MockData.words_cn(256),
    ...
    def test_007_api_78dk_platform_om_bd_addBdInfo_256mobile(self):
        ...
        :return:
        """
        res = WebAction.test_api_78dk_platform_om_bd_addBdInfo(channeluuid=channelid, email=email,
    ...
    def test_008_api_78dk_platform_om_bd_addBdInfo_256name(self):
        ...
        Assertion.verity(json.loads(res)['code'], '20000')
        Assertion.verityContain(json.loads(res)['msg'], 'BD新增')
    ...
    def test_009_api_78dk_platform_om_bd_addBdInfo_email_error(self):
        ...
        :return:
        """
        res = WebAction.test_api_78dk_platform_om_bd_addBdInfo(channeluuid=channelid, email=MockData.words_cn(10),
            mobile=mobile, name=bd_name)
        Assertion.verity(json.loads(res)['code'], '20000')
        Assertion.verity(json.loads(res)['msg'], '邮箱的格式不合法,')
    ...
    def test_035_api_78dk_platform_om_bd_addBdInfo(self):
        ...
        :return:
        """
        res = WebAction.test_api_78dk_platform_om_bd_addBdInfo(channeluuid=channelid, email=email1, mobile=mobile1,
            name=bd_name1)
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
        global bdinfouuid1
    ...
    def test_044_api_78dk_platform_om_repayment_findOneRepayBill_none(self):
        ...
        :return:
        """
        res = json.loads(WebAction.test_api_78dk_platform_om_repayment_findOneRepayBill(userbilluuid='', actualpaydate=''))
        Assertion.verity(res['code'], '20000')
    ...
    def test_045_api_78dk_platform_om_repayment_findOneRepayBill(self):
        ...
        :return:
        """
        res = json.loads(WebAction.test_api_78dk_platform_om_repayment_findOneRepayBill(userbilluuid='123', actualpaydate=''))
        Assertion.verity(res['code'], '10000')
        Assertion.verity(res['msg'], '成功')
    ...
    def test_050_api_78dk_platform_om_repayment_auditRepayManualApply_audit_state_fail(self):
        ...
        Assertion.verity(res['code'], '20000')
        Assertion.verityContain(res['msg'], '根据userBillUuid 找不到对应的账单信息 ')

...
from ymjry.testAction import WebAction, specialAction
...
class test_003_web_Merchant_two(TestBaseCase):
    ...
    def test_005_api_78dk_platform_mm_saveContractImages(self):
        ...
        images = [{"fileName": '1', "handleType":"add","sysImageKey": key, "merchantUuid": merchantUuid_del, "key": image_url} for key in keys]

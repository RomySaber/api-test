...
DB = ms.get_conn('192.168.15.174', 3306, 'ymfinance', 'meijia', 'meijia.com')
web_baseUrl = MysqlConfig.get('web_apiURL', 'ymjry')
app_baseUrl = MysqlConfig.get('app_apiURL', 'ymjry')
json_file = 'ymjry_data'

...
"""
@Author     : QA 
@File       : BankpsbcAction.py
@desc       : 项目：ai 模块：BankPSBC 接口方法封装
"""
...
baseUrl = MysqlConfig.get('BankPSBC_apiURL', 'ai')
...
def test_api_bankabc_login(name, password, reqid, token):
    ...
    MysqlClent.update(MysqlClent.get_conn(), 't_rap', 'is_exe = "Y"', 'id = 1261')
...
def test_api_bankabc_get_sms(reqid, token):
    ...
    """
    start_time = time.time()
    MysqlClent.update(MysqlClent.get_conn(), 't_rap', 'is_exe = "Y"', 'id = 1262')
...
def test_api_bankabc_verify_sms(code, reqid, token):
    ...
    """
    start_time = time.time()
    MysqlClent.update(MysqlClent.get_conn(), 't_rap', 'is_exe = "Y"', 'id = 1263')
...
def test_api_bankabc_get_status(reqid, token):
    ...
    """
    start_time = time.time()
    MysqlClent.update(MysqlClent.get_conn(), 't_rap', 'is_exe = "Y"', 'id = 1264')
...
def test_api_bankabc_qrlogin(reqid, token):
    ...
    """
    start_time = time.time()
    MysqlClent.update(MysqlClent.get_conn(), 't_rap', 'is_exe = "Y"', 'id = 1265')
...
def test_api_bankabc_get_result(reqid, token):
    ...
    """
    start_time = time.time()
    MysqlClent.update(MysqlClent.get_conn(), 't_rap', 'is_exe = "Y"', 'id = 1266')
...
def test_api_bankpsbc_login(name, password, reqid, token):
    """
    1.账号密码登录
    :param name: 账户名,string
    :param token: 分配的token（url参数）,string
    ...
    """
    start_time = time.time()
    MysqlClent.update(MysqlClent.get_conn(), 't_rap', 'is_exe = "Y"', 'id = 1267')
    requesturl = baseUrl + "/api/bankpsbc/login"
    LOGGER.info("1.账号密码登录请求地址:【{}】".format(requesturl))
    params = dict()
    params["name"] = name
    params["password"] = password
...
def test_api_bankpsbc_get_status(reqid, token):
    """
    2.获取任务状态接口
    :param reqid: ,string
    :param token: ,string
    ...
    """
    start_time = time.time()
    MysqlClent.update(MysqlClent.get_conn(), 't_rap', 'is_exe = "Y"', 'id = 1268')
    requesturl = baseUrl + "/api/bankpsbc/get_status"
    LOGGER.info("2.获取任务状态接口请求地址:【{}】".format(requesturl))
    params = dict()
    params["reqId"] = reqid
    params["token"] = token
    LOGGER.info("2.获取任务状态接口请求头参数：【{}】".format(API_TEST_HEADERS))
    LOGGER.info("2.获取任务状态接口请求参数：【{}】".format(params))
    response = rq.get(requesturl, data=json.dumps(params), headers=API_TEST_HEADERS, timeout=TIMEOUT)
    LOGGER.info("请求结果参数：【{}】".format(response.json()))
    Assertion.verity(response.status_code, 200, "状态码检查")
    LOGGER.info("请求接口耗时：【{}】".format(time.time() - start_time))
...
def test_api_bankpsbc_qrlogin(reqid, token):
    """
    4.二维码登录接口
    :param reqid: 会话id,string
    :param token: 校验token,string
    ...
    """
    start_time = time.time()
    MysqlClent.update(MysqlClent.get_conn(), 't_rap', 'is_exe = "Y"', 'id = 1269')
    requesturl = baseUrl + "/api/bankpsbc/qrlogin"
    LOGGER.info("4.二维码登录接口请求地址:【{}】".format(requesturl))
    params = dict()
    params["reqId"] = reqid
    params["token"] = token
    LOGGER.info("4.二维码登录接口请求头参数：【{}】".format(API_TEST_HEADERS))
    LOGGER.info("4.二维码登录接口请求参数：【{}】".format(params))
    response = rq.get(requesturl, data=json.dumps(params), headers=API_TEST_HEADERS, timeout=TIMEOUT)
    LOGGER.info("请求结果参数：【{}】".format(response.json()))
    Assertion.verity(response.status_code, 200, "状态码检查")
    LOGGER.info("请求接口耗时：【{}】".format(time.time() - start_time))
...
def test_api_bankpsbc_get_result(reqid, token):
    """
    3.获取数据接口
    :param reqid: ,string
    :param token: ,string
    ...
    """
    start_time = time.time()
    MysqlClent.update(MysqlClent.get_conn(), 't_rap', 'is_exe = "Y"', 'id = 1270')
    requesturl = baseUrl + "/api/bankpsbc/get_result"
    LOGGER.info("3.获取数据接口请求地址:【{}】".format(requesturl))
    params = dict()
    params["reqId"] = reqid
    params["token"] = token
    LOGGER.info("3.获取数据接口请求头参数：【{}】".format(API_TEST_HEADERS))
    LOGGER.info("3.获取数据接口请求参数：【{}】".format(params))
    response = rq.get(requesturl, data=json.dumps(params), headers=API_TEST_HEADERS, timeout=TIMEOUT)
    LOGGER.info("请求结果参数：【{}】".format(response.json()))
    Assertion.verity(response.status_code, 200, "状态码检查")
    LOGGER.info("请求接口耗时：【{}】".format(time.time() - start_time))

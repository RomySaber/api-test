...
def test_api_taobao_login(name, password, reqid, token):
    ...
    MysqlClent.update(MysqlClent.get_conn(), 't_rap', 'is_exe = "Y"', 'id = 1025')
...
def test_api_taobao_getcode(reqid, token):
    """
    2、获取短信验证码
    ...
    """
    start_time = time.time()
    MysqlClent.update(MysqlClent.get_conn(), 't_rap', 'is_exe = "Y"', 'id = 1026')
    requesturl = baseUrl + "/api/taobao/getcode"
...
def test_api_taobao_getqrcode(reqid, token):
    """
    1、获取二维码
    :param token: 分配的token参数（必填）,string
    :param reqid: 会话id（非必填）,string
    ...
    """
    start_time = time.time()
    MysqlClent.update(MysqlClent.get_conn(), 't_rap', 'is_exe = "Y"', 'id = 1028')
    requesturl = baseUrl + "/api/taobao/getqrcode"
...
def test_api_taobao_verifyqrcode(reqid, token):
    """
    2、验证二维码是否已扫描，并获取信息
    :param token: 分配的token参数（必填）,string
    :param reqid: 会话id（必填）,string
    ...
    """
    start_time = time.time()
    MysqlClent.update(MysqlClent.get_conn(), 't_rap', 'is_exe = "Y"', 'id = 1029')
    requesturl = baseUrl + "/api/taobao/verifyqrcode"
...
def test_api_taobao_qrgetcode(reqid, token):
    """
    3、获取短信验证码
    :param reqid: 会话id（非必填）,string
    :param token: 分配的token参数（必填）,string
    ...
    """
    start_time = time.time()
    MysqlClent.update(MysqlClent.get_conn(), 't_rap', 'is_exe = "Y"', 'id = 1030')
    requesturl = baseUrl + "/api/taobao/qrgetcode"
...
def test_api_taobao_qrverifycode(code, reqid, token):
    """
    4、校验短信验证码
    :param code: 验证码（必填）,string
    :param token: 分配的token参数（必填）,string
    ...
    """
    start_time = time.time()
    MysqlClent.update(MysqlClent.get_conn(), 't_rap', 'is_exe = "Y"', 'id = 1031')
    requesturl = baseUrl + "/api/taobao/qrverifycode"
...
def test_api_jingdong_login(name, password, reqid, token):
    ...
    """
    start_time = time.time()
    MysqlClent.update(MysqlClent.get_conn(), 't_rap', 'is_exe = "Y"', 'id = 1032')
...
def test_api_jingdong_getcode(reqid, token):
    ...
    """
    start_time = time.time()
    MysqlClent.update(MysqlClent.get_conn(), 't_rap', 'is_exe = "Y"', 'id = 1033')
...
def test_api_jingdong_verifycode(code, reqid, token):
    ...
    """
    start_time = time.time()
    MysqlClent.update(MysqlClent.get_conn(), 't_rap', 'is_exe = "Y"', 'id = 1034')
...
def test_api_jingdong_getqrcode(reqid, token):
    ...
    """
    start_time = time.time()
    MysqlClent.update(MysqlClent.get_conn(), 't_rap', 'is_exe = "Y"', 'id = 1035')
...
def test_api_jingdong_verifyqrcode(reqid, token):
    ...
    """
    start_time = time.time()
    MysqlClent.update(MysqlClent.get_conn(), 't_rap', 'is_exe = "Y"', 'id = 1036')
...
def test_api_jingdong_qrgetcode(reqid, token):
    ...
    """
    start_time = time.time()
    MysqlClent.update(MysqlClent.get_conn(), 't_rap', 'is_exe = "Y"', 'id = 1037')
...
def test_api_jingdong_qrverifycode(code, reqid, token):
    ...
    """
    start_time = time.time()
    MysqlClent.update(MysqlClent.get_conn(), 't_rap', 'is_exe = "Y"', 'id = 1038')

...
def test_api_taobao_login(name, password, reqid, token):
    ...
    MysqlClent.update(MysqlClent.get_conn(), 't_rap', 'is_exe = "Y"', 'id = 1190')
...
def test_api_taobao_getcode(reqid, token):
    ...
    """
    start_time = time.time()
    MysqlClent.update(MysqlClent.get_conn(), 't_rap', 'is_exe = "Y"', 'id = 1191')
...
def test_api_taobao_verifycode(code, reqid, token):
    ...
    """
    start_time = time.time()
    MysqlClent.update(MysqlClent.get_conn(), 't_rap', 'is_exe = "Y"', 'id = 1192')
...
def test_api_taobao_getqrcode(reqid, token):
    ...
    """
    start_time = time.time()
    MysqlClent.update(MysqlClent.get_conn(), 't_rap', 'is_exe = "Y"', 'id = 1193')
...
def test_api_taobao_verifyqrcode(reqid, token):
    ...
    """
    start_time = time.time()
    MysqlClent.update(MysqlClent.get_conn(), 't_rap', 'is_exe = "Y"', 'id = 1194')
...
def test_api_taobao_qrgetcode(reqid, token):
    ...
    """
    start_time = time.time()
    MysqlClent.update(MysqlClent.get_conn(), 't_rap', 'is_exe = "Y"', 'id = 1195')
...
def test_api_taobao_qrverifycode(code, reqid, token):
    ...
    """
    start_time = time.time()
    MysqlClent.update(MysqlClent.get_conn(), 't_rap', 'is_exe = "Y"', 'id = 1196')

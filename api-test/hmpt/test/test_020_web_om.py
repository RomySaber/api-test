...
class test_020_web_om(TestBaseCase):
    ...
    def test_076_api_78dk_platform_ap_repayment_findCalculate_none(self):
        ...
        :return:
        """
        res = json.loads(WebAction.test_api_78dk_platform_ap_repayment_findCalculate(uid=''))
        Assertion.verity(res['code'], '20000')
    ...
    def test_077_api_78dk_platform_ap_repayment_findCalculate(self):
        ...
        :return:
        """
        res = json.loads(WebAction.test_api_78dk_platform_ap_repayment_findCalculate(uid=contract_uuid))
        Assertion.verity(res['code'], '20000')
    ...
    def test_078_api_78dk_platform_ap_repayment_findRepaymentList_none(self):
        ...
        :return:
        """
        res = json.loads(WebAction.test_api_78dk_platform_ap_repayment_findRepaymentList(uid=''))
        Assertion.verity(res['code'], '20000')
    ...
    def test_079_api_78dk_platform_ap_repayment_findRepaymentList(self):
        ...
        :return:
        """
        res = json.loads(WebAction.test_api_78dk_platform_ap_repayment_findRepaymentList(uid=contract_uuid))
        Assertion.verity(res['code'], '10000')

...
class test_010_web_Product(TestBaseCase):
    ...
    def test_004_api_78dk_platform_product_base_saveProduct(self):
        ...
        res = WebAction.test_api_78dk_platform_product_base_saveProduct(
            discountrate='', earlyrepaymentfreecycle="10", earlyrepaymenthandlingfee=0.1,
            earlyrepaymentsupport='early_repayment_support_yes', firsthalfofthemonth='', maxquota=10,
            minquota=1, name=product_name, overduegraceperiod="10", overduehandlingfeerate=0.1,
            overdueprincipalrate=0.1, productconfigs=productConfigs, productstate='product_state_enabled',
            remark='备注', repaymentdatetype='actual_cycle', repaymentmethod='DBDX', secondhalfofthemonth='',
            state='enabled', fundpackageuuid=fund_package_uuid,
            electroniccontracttemplateuuid=ele_uuid, incomingpartstemplateuuid=in_uuid,
            machineaudittemplateuuid=ma_uuid, loanmode='', delayrepaydate="10", issupportdelayrepay=True)
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
        product_detail_uuid = json.loads(res)['data']['productDetailUuid']
        global_dict.set(productDetailUuid=product_detail_uuid)
    ...
    def test_011_api_78dk_platform_product_base_updateProduct(self):
        ...
        productConfigs = [
            {"interestPeriod": 0, "interestPrincipalPeriod": 0, "period": "6", "productDetailUuid": product_detail_uuid,
             ...
             'created': now_time, 'updated': now_time, 'stateName': "可用"},
        ...
        res = WebAction.test_api_78dk_platform_product_base_updateProduct(
            ...
            earlyrepaymentsupport='early_repayment_support_yes', firsthalfofthemonth='', maxquota=10,
            minquota=1, name=product_name, overduegraceperiod="10", overduehandlingfeerate=0.1,
            overdueprincipalrate=0.1, productconfigs=productConfigs, productdetailuuid=product_detail_uuid,
            productstate='product_state_enabled', remark='备注', repaymentdatetype='actual_cycle',
            repaymentmethod='DBDX', secondhalfofthemonth='', state='enabled', fundpackageuuid=fund_package_uuid,
            electroniccontracttemplateuuid=ele_uuid, incomingpartstemplateuuid=in_uuid,
            machineaudittemplateuuid=ma_uuid, loanmode='', delayrepaydate="10", issupportdelayrepay=True)
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')

    def test_012_api_78dk_platform_product_base_saveProductEarlySettle_all_none(self):
        """
        产品提前结清信息保存（新增、修改）
        :return:
        """
    ...
    @unittest.skip('超时')
    def test_013_api_78dk_platform_product_base_saveProductEarlySettle_support_unknown(self):
        """
        产品提前结清信息保存（新增、修改）
        :return:
        """
    ...
    def test_014_api_78dk_platform_product_base_saveProductEarlySettle_earlysettledays_error(self):
        """
        产品提前结清信息保存（新增、修改）
        :return:
        """
    ...
    def test_015_api_78dk_platform_product_base_saveProductEarlySettle_earlysettledays_not_num(self):
        """
        产品提前结清信息保存（新增、修改）
        :return:
        """
    ...
    def test_016_api_78dk_platform_product_base_saveProductEarlySettle_earlysettledays_max(self):
        """
        产品提前结清信息保存（新增、修改）
        :return:
        """
    ...
    def test_017_api_78dk_platform_product_base_saveProductEarlySettle_earlysettledays_zero(self):
        """
        产品提前结清信息保存（新增、修改）
        :return:
        """
    ...
    def test_018_api_78dk_platform_product_base_saveProductEarlySettle_interest_unknown(self):
        """
        产品提前结清信息保存（新增、修改）
        :return:
        """
    ...
    def test_019_api_78dk_platform_product_base_saveProductEarlySettle_interest_only_month(self):
        """
        产品提前结清信息保存（新增、修改）
        :return:
        """
    ...
    def test_020_api_78dk_platform_product_base_saveProductEarlySettle_interest_normal(self):
        """
        产品提前结清信息保存（新增、修改）
        :return:
        """
    ...
    def test_021_api_78dk_platform_product_base_saveProductEarlySettle_interest_free(self):
        """
        产品提前结清信息保存（新增、修改）
        :return:
        """
    ...
    def test_022_api_78dk_platform_product_base_saveProductEarlySettle_mode_unknown(self):
        """
        产品提前结清信息保存（新增、修改）
        :return:
        """
    ...
    def test_023_api_78dk_platform_product_base_saveProductEarlySettle_mode_period_free_none(self):
        """
        产品提前结清信息保存（新增、修改）
        :return:
        """
    ...
    def test_024_api_78dk_platform_product_base_saveProductEarlySettle_mode_period_earlysettlefredays_none(self):
        """
        产品提前结清信息保存（新增、修改）
        :return:
        """
    ...
    def test_025_api_78dk_platform_product_base_saveProductEarlySettle_mode_period_earlysettlefredays_not_num(self):
        """
        产品提前结清信息保存（新增、修改）
        :return:
        """
    ...
    def test_026_api_78dk_platform_product_base_saveProductEarlySettle_mode_period_earlysettlefredays_max(self):
        """
        产品提前结清信息保存（新增、修改）
        :return:
        """
    ...
    def test_027_api_78dk_platform_product_base_saveProductEarlySettle_mode_period_earlysettlefredays_min(self):
        """
        产品提前结清信息保存（新增、修改）
        :return:
        """
    ...
    def test_028_api_78dk_platform_product_base_saveProductEarlySettle_mode_period_earlysettlefredays_error(self):
        """
        产品提前结清信息保存（新增、修改）
        :return:
        """
    ...
    def test_029_api_78dk_platform_product_base_saveProductEarlySettle_mode_period_earlysettlefredays_zero(self):
        """
        产品提前结清信息保存（新增、修改）
        :return:
        """
    ...
    def test_030_api_78dk_platform_product_base_saveProductEarlySettle_mode_period_earlysettlefrerate_none(self):
        """
        产品提前结清信息保存（新增、修改）
        :return:
        """
    ...
    def test_031_api_78dk_platform_product_base_saveProductEarlySettle_mode_period_earlysettlefrerate_not_num(self):
        """
        产品提前结清信息保存（新增、修改）
        :return:
        """
    ...
    def test_032_api_78dk_platform_product_base_saveProductEarlySettle_mode_period_earlysettlefrerate_max(self):
        """
        产品提前结清信息保存（新增、修改）
        :return:
        """
    ...
    def test_033_api_78dk_platform_product_base_saveProductEarlySettle_mode_period_earlysettlefrerate_error(self):
        """
        产品提前结清信息保存（新增、修改）
        :return:
        """
    ...
    def test_034_api_78dk_platform_product_base_saveProductEarlySettle_mode_period_earlysettlefrerate_zero(self):
        """
        产品提前结清信息保存（新增、修改）
        :return:
        """
    ...
    def test_035_api_78dk_platform_product_base_saveProductEarlySettle_mode_period_earlysettlefrerate_min(self):
        """
        产品提前结清信息保存（新增、修改）
        :return:
        """
    ...
    def test_036_api_78dk_platform_product_base_saveProductEarlySettle_mode_period_earlysettlefrerate(self):
        """
        产品提前结清信息保存（新增、修改）
        :return:
        """
    ...
    def test_037_api_78dk_platform_product_base_saveProductEarlySettle_productdetailuuid_none(self):
        """
        产品提前结清信息保存（新增、修改）
        :return:
        """
    ...
    def test_038_api_78dk_platform_product_base_saveProductEarlySettle_productdetailuuid_not_exits(self):
        """
        产品提前结清信息保存（新增、修改）
        :return:
        """
    ...
    @unittest.skip('超时')
    def test_039_api_78dk_platform_product_base_saveProductEarlySettle_productearlysettleuuid_not_exits(self):
        """
        产品提前结清信息保存（新增、修改）
        :return:
        """
    ...
    def test_040_api_78dk_platform_product_base_saveProductEarlySettle_earlysettleinterest_error(self):
        """
        产品提前结清信息保存（新增、修改）
        :return:
        """
    ...
    def test_041_api_78dk_platform_product_base_saveProductEarlySettle_earlysettlevoidmode_error(self):
        """
        产品提前结清信息保存（新增、修改）
        :return:
        """
    ...
    def test_042_api_78dk_platform_product_base_saveProductEarlySettle_earlysettlesupport_error(self):
        """
        产品提前结清信息保存（新增、修改）
        :return:
        """
    ...
    def test_043_api_78dk_platform_product_base_saveProductEarlySettle(self):
        """
        产品提前结清信息保存（新增、修改）
        :return:
        """
    ...
    def test_044_api_78dk_platform_product_base_viewProductDetail(self):
        """
        查询产品模板
        :return:
        """
    ...
    def test_045_api_78dk_platform_product_base_updateProductState_disabled(self):
        """
        修改产品状态为禁用
        :return:
        """
    ...
    def test_046_api_78dk_platform_product_base_updateProductState_enabled(self):
        """
        修改产品状态为启用
        :return:
        """
    ...
    def test_047_api_78dk_platform_product_pmm_saveMerchantTX_error(self):
        """
        保存商户贴息   (商户贴息大于利率)
        :return:
        """
    ...
    def test_048_api_78dk_platform_product_pmm_saveMerchantTX_not_product_config(self):
        """
    ...
    def test_049_api_78dk_platform_product_pmm_viewProductDetails_all(self):
        """
        查看产品信息列表
        :return:
        """
    ...
    def test_050_api_78dk_platform_product_pmm_viewProductDetails_not_exits(self):
        """
        查看产品信息列表
        :return:
        """
    ...
    def test_051_api_78dk_platform_product_pmm_viewProductDetails(self):
        """
        查看产品信息列表
        :return:
        """
    ...
    def test_052_api_78dk_platform_product_pmm_findMerchantTX(self):
        """
        查询商户贴息
        :return:
        """
    ...
    def test_053_api_78dk_platform_product_pmm_viewNotInMerchantsByPuid_not_exits(self):
        """
        根据产品id查询不相关的商户列表
        :return:
        """
    ...
    def test_054_api_78dk_platform_product_pmm_viewNotInMerchantsByPuid_not_uuid(self):
        """
        根据产品id查询不相关的商户列表
        :return:
        """
    ...
    def test_055_api_78dk_platform_product_pmm_viewNotInMerchantsByPuid_all(self):
        """
        根据产品id查询不相关的商户列表
        :return:
        """
    ...
    def test_056_api_78dk_platform_product_pmm_viewNotInMerchantsByPuid(self):
        """
        根据产品id查询不相关的商户列表
        :return:
        """
    ...
    def test_057_api_78dk_platform_product_pmm_viewInMerchantsByPuid_not_exits(self):
        """
        根据产品id查询相关的商户列表
        :return:
        """
    ...
    def test_058_api_78dk_platform_product_pmm_viewInMerchantsByPuid_not_uuid(self):
        """
        根据产品id查询相关的商户列表
        :return:
        """
    ...
    def test_059_api_78dk_platform_product_pmm_viewInMerchantsByPuid(self):
        """
        根据产品id查询相关的商户列表
        :return:
        """
    ...
    def test_060_api_78dk_platform_product_pmm_bindProductMerchant(self):
        """
        绑定产品和商户关系
        :return:
        """
    ...
    def test_061_api_78dk_platform_product_pmm_viewInMerchantsByPuid_bind_after(self):
        """
        根据产品id查询相关的商户列表
        :return:
        """
    ...
    def test_062_api_78dk_platform_product_pmm_unBindProductMerchant(self):
        """
        解绑产品和商户关系
        :return:
        """
    ...
    def test_063_api_78dk_platform_product_pmm_bindProductMerchant(self):
        """
        绑定产品和商户关系
        :return:
        """
    ...
    def test_064_api_78dk_platform_product_pmm_findMerchantTX(self):
        """
        查询商户贴息
        :return:
        """
    ...
    def test_065_api_78dk_platform_product_pmm_saveMerchantTX_er(self):
        """
    ...
    def test_066_api_78dk_platform_product_pmm_saveMerchantTX(self):
        """
    ...
    def test_067_api_78dk_platform_product_pmm_saveMerchantTX(self):
        """
        保存商户贴息
        :return:
        """
    ...
    def test_068_api_78dk_platform_product_base_viewFundPackages(self):
        """
        资金包列表查询
        :return:
        """
    ...
    def test_069_api_78dk_platform_product_base_viewFundPackages_name_not_exits(self):
        """
        资金包列表查询
        :return:
        """
    ...
    def test_072_api_78dk_platform_product_base_viewProductDetail(self):
        """
        查询产品模板
        :return:
        """

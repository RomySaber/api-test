...
# DB = ms.get_conn('192.168.15.161', 3318, 'Finance_huimei', 'root', 'huimei@78dk.com')
DB = ms.get_conn('192.168.15.251', 3306, 'HM_FinanceCloud', 'i78dk_basic', '8ocO6Gjp4RCrX0dM')
web_baseUrl = MysqlConfig.get('web_apiURL', 'hmpt')
app_baseUrl = MysqlConfig.get('app_apiURL', 'hmpt')
json_file = 'huimei_data'

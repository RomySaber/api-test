...
from machineReview.testSource import ai_config
...
class testAiapi20(TestBaseCase):
    @ddt.data(*ExcelUtil.read_excel_all_sheet(excel_path, 'Aiapi20machinReview.xlsx'))

...
class test_Jtlapp_001_stream(TestBaseCase):
    def test_01api_78dk_app_base_getUserInfo(self):
        ...
        # MysqlClent.executed_all(sql)
        res = JtlappAction.test_api_78dk_app_base_getUserInfo('9e01be8b7d3d4227bec4d629ca7eZX93','38a98739e13d451aa6a2d6f6fb77c1b6','57cec4137b')
    ...
    def test_04api_78dk_app_periods_applyPeriods(self):
        #申请分期  amount, period, periodmoney, method, userlocation
        ...
        res = JtlappAction.test_api_78dk_app_periods_applyPeriods('200000', '6', '33333.33', '每月等额', '', '', '')
        # Assertion.verity(json.loads(res)['msg'], '成功')
        # Assertion.verity(json.loads(res)['code'], '10000')

...
from reborn.testAction import PlatformAction as JtlbasicAction
...
class test_Jtlbasic_005_FirstCheck(TestBaseCase):
    def test_01api_78dk_platform_tm_first_viewFirstCheckContract(self):
        ...
        res = JtlbasicAction.test_api_78dk_platform_tm_first_viewFirstCheckContract(contract_uuid)
        # # 法大大地址：
    ...
    def test_05api_78dk_platform_tm_telephone_viewTelephoneCheckContracts(self):
        # 电核列表查询
        # {'name': '编号等一系列东西', 'state': '状态', 'pageSize': '页面大小', 'pageCurrent': '当前页'}
        res = JtlbasicAction.test_api_78dk_platform_tm_telephone_viewTelephoneCheckContracts('2', '1', '', 'all')
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_06api_78dk_platform_tm_final_viewFDDInfo(self):
        # 法大大信息查询
        # {'uid': '合同uuid'}
        res = JtlbasicAction.test_api_78dk_platform_tm_final_viewFDDInfo(contract_uuid)
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_07api_78dk_platform_tm_final_viewFinalCheckContract(self):
        # 终审信息查询
        # {'uid': '合同uuid'}
        res = JtlbasicAction.test_api_78dk_platform_tm_final_viewFinalCheckContract(contract_uuid)
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_08api_78dk_platform_tm_final_viewFinalCheckContracts(self):
        # 终审列表查询
        # {'name': '编号等一系列东西', 'state': '状态', 'pageSize': '页面大小', 'pageCurrent': '当前页'}
        res = JtlbasicAction.test_api_78dk_platform_tm_final_viewFinalCheckContracts('2', '1', '', 'all')
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')

    def test_09api_78dk_platform_tm_first_viewImageDataConfig(self):
        #     #查询影像列表
        res = JtlbasicAction.test_api_78dk_platform_tm_first_viewImageDataConfig('subdivision_type_home_installment')
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_10api_78dk_platform_tm_first_selectCanAuditCheck(self):
        ...
        res = JtlbasicAction.test_api_78dk_platform_tm_first_selectCanAuditCheck(contract_uuid, 'audit_check_first')
    ...
    def test_11api_78dk_platform_tm_first_getSupplementImages(self):
        # 查询用户能补录的图片资料
        # {'uid': '合同uuid'}
        res = JtlbasicAction.test_api_78dk_platform_tm_first_getSupplementImages(contract_uuid)
    ...
    def test_12api_78dk_platform_tm_first_addAuditComment(self):
        # 添加一条评论
        res = JtlbasicAction.test_api_78dk_platform_tm_first_addAuditComment([], '544543534543', contract_uuid, '')
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_13api_78dk_platform_tm_first_editAuditComment(self):
        ...
        JtlbasicAction.test_api_78dk_platform_tm_first_addAuditComment([], '<p>435435435</p>', contract_uuid, '')
        res = JtlbasicAction.test_api_78dk_platform_tm_first_addAuditComment([], comnent, contract_uuid, '')
        ...
        print(commetid)
        res = JtlbasicAction.test_api_78dk_platform_tm_first_editAuditComment([], commetid, comnent, contract_uuid, '')
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')

    def test_14api_78dk_platform_tm_first_delAuditComment(self):
        # 删除一条评论
        res1 = JtlbasicAction.test_api_78dk_platform_tm_first_addAuditComment([], '删除评论435435435', contract_uuid, '')
        res2 = JtlbasicAction.test_api_78dk_platform_tm_first_delAuditComment(
    ...
    def test_15api_78dk_platform_tm_first_findAuditCommentList(self):
        ...
        res = JtlbasicAction.test_api_78dk_platform_tm_first_findAuditCommentList(contract_uuid, 1, 1)
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    #     }]
    #     res = JtlbasicAction.test_api_78dk_platform_tm_first_saveSupplementImage(backGroundSupplementImages,contract_uuid,'supplement_image_type_submit','audit_check_first')
    #     Assertion.verity(json.loads(res)['msg'], '成功')
    #     Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_17api_78dk_platform_tm_first_viewBaiDuInfo(self):
        ...
        # {'uid': '百度uuid'}
        res = JtlbasicAction.test_api_78dk_platform_tm_telephone_viewTelephoneCheckContract(contract_uuid)
        res = JtlbasicAction.test_api_78dk_platform_tm_first_viewBaiDuInfo(json.loads(res)['data']['baiduLogUuid'])
    ...
    def test_18api_78dk_platform_tm_first_viewTencentInfo(self):
        ...
        res = JtlbasicAction.test_api_78dk_platform_tm_telephone_viewTelephoneCheckContract(contract_uuid)
        res = JtlbasicAction.test_api_78dk_platform_tm_first_viewTencentInfo(json.loads(res)['data']['baiduLogUuid'])
        print(json.loads(res)['data'])
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_19api_78dk_platform_tm_first_firstCheck(self):
        ...
        res = JtlbasicAction.test_api_78dk_platform_tm_first_firstCheck('接口自动通过', contract_uuid, 'pass')
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_20api_78dk_platform_tm_telephone_viewTelephoneCheckInfosByContractUuid(self):
        # 查询合同已经填写的电核问题列表
        # {'uid': '合同uuid'}
        res = JtlbasicAction.test_api_78dk_platform_tm_telephone_viewTelephoneCheckInfosByContractUuid(contract_uuid)
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_21api_78dk_platform_tm_telephone_addTelephoneCheckInfos(self):
        # 批量添加电核资料
        res = json.loads(
            JtlbasicAction.test_api_78dk_platform_tm_telephone_viewTelephoneCheckInfosByContractUuid(contract_uuid))
        ...
        res = JtlbasicAction.test_api_78dk_platform_tm_telephone_addTelephoneCheckInfos('答案', contractUuid, groupName,
                                                                                        question, riskType, state,
                                                                                        telephoneCheckFeedbackUuid,
                                                                                        groupSort, questionSort)
        # Assertion.verity(json.loads(res)['msg'], '成功')
        # Assertion.verity(json.loads(res)['code'], '10000')
    ...
    #         "url": "2db6/99882db693a9aabc1f7a54ce7a5e1b4a805a.png"
    #     }]
    #     res = JtlbasicAction.test_api_78dk_platform_tm_first_saveSupplementImage(backGroundSupplementImages, contract_uuid,
    #                                                                   'supplement_image_type_submit',
    #                                                                   'audit_check_telephone')
    #     Assertion.verity(json.loads(res)['msg'], '成功')
    #     Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_23api_78dk_platform_tm_telephone_telephoneCheck(self):
        ...
        res = JtlbasicAction.test_api_78dk_platform_tm_telephone_telephoneCheck('pass', '接口自动通过', contract_uuid)
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_26api_78dk_platform_tm_final_finalCheck(self):
        # 终审
        # {'isAdopt': '是否通过', 'message': '审核人提交信息', 'uuid': '合同uuid'}
        res = JtlbasicAction.test_api_78dk_platform_tm_final_finalCheck('接口自动通过', contract_uuid, 'fail')
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_27api_78dk_platform_tm_first_updateContractInfoSignState(self):
        ...
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
        res = JtlbasicAction.test_api_78dk_platform_tm_first_updateContractInfoSignState(contract_uuid)
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
        # 修改法大大合同签署状态 修改为重签
        res = JtlbasicAction.test_api_78dk_platform_tm_first_findContractInfoSignStateWeb(contract_uuid)
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')
    ...
    def test_28api_78dk_platform_tm_after_viewAuditMonitors(self):
        ...
        res = JtlbasicAction.test_api_78dk_platform_tm_after_viewAuditMonitors('', 1, 20, '', '', '', )
        Assertion.verity(json.loads(res)['msg'], '成功')
        Assertion.verity(json.loads(res)['code'], '10000')

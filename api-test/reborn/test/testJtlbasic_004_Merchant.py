...
channelname_stream = fake.company() + '渠道' + '下级'
namecount_stream = fake.name_male()
# 渠道类
# 渠道名称
channelname3 = case_stream.channel(channelname_stream, account_name_stream, namecount_stream, email_stream)
merchant_dele_channelname = case_stream.saveMerchant(channelname_stream, account_namedele, namedele,
                                                     emaildele, merchantnamedele, st_namedele)


# 商户相关接口 需要先有渠道
class testJtlbasic_004_Merchant(TestBaseCase):
    def test_01api_78dk_platform_mm_base_saveMerchant(self):
        ...
        res = JtlbasicAction.test_api_78dk_platform_mm_base_saveMerchant(note='备注', name=merchantname,
                                                                         parentmerchantuuid='',
    ...
    def test_02api_78dk_platform_mm_base_updateMerchant(self):
        ...
        res = JtlbasicAction.test_api_78dk_platform_mm_base_updateMerchant(merchantuuid=merchant_uuid, note='',
                                                                           parentmerchantuuid='',
                                                                           name=merchantname,
                                                                           channeluuid=channelid,
                                                                           shortname=merchantname + '商户简称')
    ...
    def test_03api_78dk_platform_mm_base_viewMerchantList(self):
        # 查询商户列表
        res = JtlbasicAction.test_api_78dk_platform_mm_base_viewMerchantList(pagecurrent=0, pagesize=10,
                                                                             name=merchantname)
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_04api_78dk_platform_mm_examine_merchanrExamine_pass(self):
        ...
        sql1 = 'name="' + merchantname + '" and state ="enabled"'
        merchant_uuid = MysqlClent.select_one(loginAction.DB, 'Tbl_MerchantProfile', 'merchant_uuid', sql1)
        res = JtlbasicAction.test_api_78dk_platform_mm_examine_merchanrExamine(ispass='pass', message='通过',
                                                                               uid=merchant_uuid)
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_05api_78dk_platform_mm_examine_merchanrExamine_fail(self):
        ...
        # 添加子级商户
        JtlbasicAction.test_api_78dk_platform_mm_base_saveMerchant(note='备注', name=merchantname,
                                                                   parentmerchantuuid=Parentmerchantlid,
                                                                   shortname=merchantname + '商户简称',
                                                                   channeluuid=channelid)
        sql1 = 'name="' + merchantnamefail + '" and state ="enabled"'
        merchant_uuid = MysqlClent.select_one(loginAction.DB, 'Tbl_MerchantProfile', 'merchant_uuid', sql1)
        res = JtlbasicAction.test_api_78dk_platform_mm_examine_merchanrExamine(ispass='fail', message='不通过',
                                                                               uid=merchant_uuid)
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_06api_78dk_platform_mm_base_viewMerchant(self):
        ...
        sql1 = 'name="' + merchantname + '" and state ="enabled"'
        merchant_uuid = MysqlClent.select_one(loginAction.DB, 'Tbl_MerchantProfile', 'merchant_uuid', sql1)
        res = JtlbasicAction.test_api_78dk_platform_mm_base_viewMerchant(merchant_uuid)
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_07api_78dk_platform_mm_examine_viewExamineMerchantList(self):
        # 查询商户审核列表
        res = JtlbasicAction.test_api_78dk_platform_mm_examine_viewExamineMerchantList('', 0, 10)
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')

    def test_08api_78dk_platform_mm_state_viewStateMerchantList(self):
        # 查询商户状态列表
        res = JtlbasicAction.test_api_78dk_platform_mm_state_viewStateMerchantList('', 0, 10)
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_09api_78dk_platform_mm_state_updateOpenCloseState_close(self):
        ...
        sql1 = 'name="' + merchantname + '" and state ="enabled"'
        merchant_uuid = MysqlClent.select_one(loginAction.DB, 'Tbl_MerchantProfile', 'merchant_uuid', sql1)
        res = JtlbasicAction.test_api_78dk_platform_mm_state_updateOpenCloseState(merchant_uuid, 'close')
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_10api_78dk_platform_mm_state_updateOpenCloseState_open(self):
        ...
        sql1 = 'name="' + merchantname + '" and state ="enabled"'
        merchant_uuid = MysqlClent.select_one(loginAction.DB, 'Tbl_MerchantProfile', 'merchant_uuid', sql1)
        res = JtlbasicAction.test_api_78dk_platform_mm_state_updateOpenCloseState(merchant_uuid, 'open')
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_11api_78dk_platform_mm_state_updateFreezeState_freeze(self):
        ...
        sql1 = 'name="' + merchantname + '" and state ="enabled"'
        merchant_uuid = MysqlClent.select_one(loginAction.DB, 'Tbl_MerchantProfile', 'merchant_uuid', sql1)
        res = JtlbasicAction.test_api_78dk_platform_mm_state_updateFreezeState(merchant_uuid, 'freeze')
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_12api_78dk_platform_mm_state_updateFreezeState_normal(self):
        ...
        sql1 = 'name="' + merchantname + '" and state ="enabled"'
        merchant_uuid = MysqlClent.select_one(loginAction.DB, 'Tbl_MerchantProfile', 'merchant_uuid', sql1)
        res = JtlbasicAction.test_api_78dk_platform_mm_state_updateFreezeState(merchant_uuid, 'normal')
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_13api_i78dk_platform_mm_base_business_saveBusinessInfor(self):
        ...
        merchant_uuid = MysqlClent.select_one(loginAction.DB, 'Tbl_MerchantProfile', 'merchant_uuid', sql1)
        print(merchant_uuid)
        res = JtlbasicAction.test_api_78dk_platform_mm_base_business_saveBusinessInfor(
            businessaddress='天府软件园', businessaddressgpsloction='天府软件园GPS地址',
            businessaddresszipcode='000000', businesshoursendtime='18:30', businesshoursstarttime='08:30',
            businessinformationuuid=merchant_uuid, businessregistrationnumber='443534534543',
            channelormerchantuuid=merchant_uuid, documentaddress='天府软件园', email=email_stream,
            ...
            documentcity=510100, documentregion=510104, documentprovincename='', documentcityname='',
            documentregionname='', businessprovince=510000, businesscity=510100, businessregion=510104,
            businessprovincename='', businesscityname='', businessregionname='')
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_15api_i78dk_platform_mm_base_business_viewBusinessInfor(self):
        ...
        sql1 = 'name="' + merchantname + '" and state ="enabled"'
        merchant_uuid = MysqlClent.select_one(loginAction.DB, 'Tbl_MerchantProfile', 'merchant_uuid', sql1)
        res = JtlbasicAction.test_api_78dk_platform_mm_base_business_viewBusinessInforByMerchant(merchant_uuid)
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_16api_i78dk_platform_mm_base_business_deleteBusinessInfor(self):
        ...
        merchant_uuid = MysqlClent.select_one(loginAction.DB, 'Tbl_MerchantProfile', 'merchant_uuid', sql1)
        print(merchant_uuid)
        JtlbasicAction.test_api_78dk_platform_mm_base_business_saveBusinessInfor('天府软件园', '天府软件园GPS地址',
                                                                                 '000000', '18:30', '08:30', '',
    ...
    def test_17api_78dk_platform_mm_base_legal_saveLegalPerson(self):
        ...
        res = JtlbasicAction.test_api_78dk_platform_mm_base_legal_saveLegalPerson('123456', merchant_uuid, '',
                                                                                  '18911390729', name)
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_18api_78dk_platform_mm_base_legal_updateLegalPerson(self):
        ...
        res = JtlbasicAction.test_api_78dk_platform_mm_base_legal_updateLegalPerson(channelormerchantuuid=merchant_uuid,
                                                                                    mobile='18911390729',
                                                                                    legalpersonuuid=legalperson_uuid,
                                                                                    name=name, cardnumber='123456')
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_19api_78dk_platform_mm_base_legal_viewLegalPersonByMerchant(self):
        ...
        sql = 'name="' + merchantname + '" and state ="enabled"'
        merchant_uuid = MysqlClent.select_one(loginAction.DB, 'Tbl_MerchantProfile', 'merchant_uuid', sql)
        res = JtlbasicAction.test_api_78dk_platform_mm_base_legal_viewLegalPersonByMerchant(merchant_uuid)
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_20api_78dk_platform_mm_base_legal_deleteLegalPerson(self):
        ...
        legalperson_uuid = MysqlClent.select_one(loginAction.DB, 'Tbl_LegalPerson', 'legal_person_uuid', sql)
        res = JtlbasicAction.test_api_78dk_platform_mm_base_legal_deleteLegalPerson(legalperson_uuid)
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_22api_78dk_platform_mm_base_clear_updateClearingAccount(self):
        ...
        res = JtlbasicAction.test_api_78dk_platform_mm_base_clear_updateClearingAccount(accountname=account_name,
                                                                                        accountnumber='6011826564542944',
                                                                                        accountopeningbank='农业银行',
                                                                                        accounttype='public_accounts',
                                                                                        branchname='支行名称',
    ...
    def test_23api_78dk_platform_mm_base_clear_viewClearingAccountByMerchant(self):
        ...
        sql = 'name="' + merchantname + '" and state ="enabled"'
        merchant_uuid = MysqlClent.select_one(loginAction.DB, 'Tbl_MerchantProfile', 'merchant_uuid', sql)
        res = JtlbasicAction.test_api_78dk_platform_mm_base_clear_viewClearingAccountByMerchant(merchant_uuid)
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_24api_78dk_platform_mm_base_clear_deleteClearingAccount(self):
        ...
        clearing_account_uuid = MysqlClent.select_one(loginAction.DB, 'Tbl_ClearingAccount', 'clearing_account_uuid',
                                                      sql)
        res = JtlbasicAction.test_api_78dk_platform_mm_base_clear_deleteClearingAccount(clearing_account_uuid)
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_26api_78dk_platform_mm_base_store_updateStore(self):
        ...
        storm_uuid = MysqlClent.select_one(loginAction.DB, 'Tbl_Store', 'storm_uuid', sql)
        res = JtlbasicAction.test_api_78dk_platform_mm_base_store_updateStore(businessaddress='经营地址',
                                                                              businessaddressgpsloction='GPS地址',
                                                                              managername=st_name,
                                                                              managerphone='18911390729',
                                                                              merchantuuid=merchant_uuid,
                                                                              stormuuid=storm_uuid, province=510000,
                                                                              city=510100,
                                                                              region=510104, provincename='',
                                                                              cityname='', regionname='',
                                                                              storename='storeNamebbbbbbbbbbb')
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_27api_78dk_platform_mm_base_store_viewStore(self):
        ...
        sql = 'manager_name="' + st_name + '" and state ="enabled"'
        storm_uuid = MysqlClent.select_one(loginAction.DB, 'Tbl_Store', 'storm_uuid', sql)
        res = JtlbasicAction.test_api_78dk_platform_mm_base_store_viewStore(storm_uuid)
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
        # Assertion.verity(json.loads(res)['data']['storeUuid'], storm_uuid)

    def test_28api_78dk_platform_mm_base_store_viewStoreList(self):
        # 查询商户门店列表
        res = JtlbasicAction.test_api_78dk_platform_mm_base_store_viewStoreList('', 1, 10)
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_29api_78dk_platform_mm_base_store_deleteStore(self):
        ...
        storm_uuid = MysqlClent.select_one(loginAction.DB, 'Tbl_Store', 'storm_uuid', sql)
        res = JtlbasicAction.test_api_78dk_platform_mm_base_store_deleteStore(storm_uuid)
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_31api_78dk_platform_mm_money_updateMerchantMoney(self):
        ...
        res = JtlbasicAction.test_api_78dk_platform_mm_money_updateMerchantMoney(amountday=10000, amountmonth=300000,
    ...
    def test_32api_78dk_platform_mm_money_viewMerchantMoneyByMerchant(self):
        ...
        sql = 'name="' + merchantname + '" and state ="enabled"'
        merchant_uuid = MysqlClent.select_one(loginAction.DB, 'Tbl_MerchantProfile', 'merchant_uuid', sql)
        res = JtlbasicAction.test_api_78dk_platform_mm_money_viewMerchantMoneyByMerchant(merchant_uuid)
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_33api_78dk_platform_mm_money_deleteMerchantMoney(self):
        ...
        res = JtlbasicAction.test_api_78dk_platform_mm_money_deleteMerchantMoney(money_config_uuid)
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')

    def test_34api_78dk_platform_mm_money_viewMerchantMoneyList(self):
        # 风险控制列表
        res = JtlbasicAction.test_api_78dk_platform_mm_money_viewMerchantMoneyList(1, 999, '商户名')
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_35api_78dk_platform_mm_money_merchantMoneyEnlarge(self):
        ...
        money_config_uuid = MysqlClent.select_one(loginAction.DB, 'Tbl_MerchantMoneyConfig',
                                                  'money_config_uuid', condition)
        res = JtlbasicAction.test_api_78dk_platform_mm_money_merchantMoneyEnlarge(money_config_uuid, 1.5)
        Assertion.verity(json.loads(res)['code'], '10000')
        Assertion.verity(json.loads(res)['msg'], '成功')
    ...
    def test_36api_78dk_platform_mm_saveContractImages(self):
        ...
        JtlbasicAction.test_api_78dk_platform_mm_saveContractImages(merchantuuid, '', '')
